...
public class LoginView extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        userIdField.setFont(new java.awt.Font("SansSerif", 0, 12));

        jLabel3.setText("パスワード：");

        passwordField.setFont(new java.awt.Font("SansSerif", 0, 12));

        settingBtn.setText("設 定");
        settingBtn.setHorizontalTextPosition(javax.swing.SwingConstants.LEADING);
