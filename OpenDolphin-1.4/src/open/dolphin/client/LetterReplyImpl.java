 ...
 */
public class LetterReplyImpl extends AbstractChartDocument implements Letter {
    ...
    public void start() {
        ...
        // IMEを自動で制御するための Focus Listener をセットする
