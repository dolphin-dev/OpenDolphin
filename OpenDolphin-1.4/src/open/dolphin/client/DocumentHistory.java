...
public class DocumentHistory {
    ...
    private void initComponent() {
        ...
        extractionObjects[1] = new NameValuePair("2年", "-24");
        extractionObjects[2] = new NameValuePair("3年", "-36");
        extractionObjects[3] = new NameValuePair("4年", "-48");
        extractionObjects[4] = new NameValuePair("5年", "-60");
        extractionObjects[5] = new NameValuePair("全て", "-120");
        ...
        contentObject[3] = new NameValuePair("ご報告", IInfoModel.DOCTYPE_LETTER_REPLY2);
