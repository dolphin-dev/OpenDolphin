...
public class ProjectStub implements java.io.Serializable {
    ...
    public boolean isValid() {
        ...
        // MML送信を行う場合の確認をする
        if (getSendMML()) {
            if (getUploadShareDirectory()==null || getUploadShareDirectory().equals("")) {
                return false;
            }
        }
    ...
    public Project.UserType getUserType() {
        ...
        String userType = prefs.get(Project.USER_TYPE, Project.UserType.ASP_TESTER.toString());
    ...
    public void setCreateKarteMode(int mode) {
        prefs.putInt(Project.KARTE_CREATE_MODE, mode);
    }
    ...
    public String getBindAddress() {
        return prefs.get("BIND_ADDRESS", null);
    }

    public void setBindAddress(String val) {
        prefs.put("BIND_ADDRESS", val);
    }
