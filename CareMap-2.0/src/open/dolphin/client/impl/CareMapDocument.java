...
public final class CareMapDocument extends AbstractChartDocument {
    ...
    private static final String[] orderNames = { "処方", "処置", "指導", "ラボテスト", "生体検査", "手術", "放射線"};
    
    private static final String[] orderCodes = { "medOrder", "treatmentOrder", "instractionChargeOrder", "testOrder", "physiologyOrder", "surgeryOrder", "radiologyOrder"};
