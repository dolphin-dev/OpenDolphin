...
//            }
        ...
        public void restore(ProjectStub stub) {
            ...
            Project.setBoolean(Project.SEND_MML, b);    //stub.setSendMML(b);
            
            // MML バージョン
            //String val = mml3.isSelected() ? "300" : "230";
            Project.setString(Project.MML_VERSION, "230");  //stub.setMMLVersion("230");
...
//            }
            ...
            if (! val.equals("")) {
                ...
                Project.setString(Project.SEND_MML_DIRECTORY, val); //stub.setUploadShareDirectory(val);
