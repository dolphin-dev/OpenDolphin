...
public class Baka extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        lineBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/open/dolphin/impl/scheam/resources/LineOff.gif"))); // NOI18N
        lineBtn.setToolTipText("直線を書きます。");
        lineBtn.setMargin(new java.awt.Insets(4, 4, 3, 3));

        rectBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/open/dolphin/impl/scheam/resources/RectOff.gif"))); // NOI18N
        rectBtn.setToolTipText("四角形を書きます。");
        rectBtn.setMargin(new java.awt.Insets(4, 4, 3, 3));

        ovalBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/open/dolphin/impl/scheam/resources/OvalOff.gif"))); // NOI18N
        ovalBtn.setToolTipText("楕円を書きます。");
        ovalBtn.setMargin(new java.awt.Insets(4, 4, 3, 3));

        polyBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/open/dolphin/impl/scheam/resources/PolyOff.gif"))); // NOI18N
        polyBtn.setToolTipText("閉じたパスを書きます。");
        polyBtn.setMargin(new java.awt.Insets(4, 4, 3, 3));

        rectFillBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/open/dolphin/impl/scheam/resources/FillRectOff.gif"))); // NOI18N
        rectFillBtn.setToolTipText("塗りつぶしの四角形を書きます。");
        rectFillBtn.setMargin(new java.awt.Insets(4, 4, 3, 3));

        ovalFillBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/open/dolphin/impl/scheam/resources/FillOvalOff.gif"))); // NOI18N
        ovalFillBtn.setToolTipText("塗りつぶしの楕円を書きます。");
        ovalFillBtn.setMargin(new java.awt.Insets(4, 4, 3, 3));

        polyFillBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/open/dolphin/impl/scheam/resources/FillPolyOff.gif"))); // NOI18N
        polyFillBtn.setToolTipText("塗りつぶしのポリゴンを書きます。");
        polyFillBtn.setMargin(new java.awt.Insets(4, 4, 3, 3));

        textBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/open/dolphin/impl/scheam/resources/TextOff.gif"))); // NOI18N
        ...
        undoBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/open/dolphin/impl/scheam/resources/undo_24.gif"))); // NOI18N
        undoBtn.setToolTipText("やり直しをします。");

        clearBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/open/dolphin/impl/scheam/resources/remov_24.gif"))); // NOI18N
        ...
        selectBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/open/dolphin/impl/scheam/resources/move_24.gif"))); // NOI18N
        selectBtn.setToolTipText("図形を選択し移動します。");

        openPathBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/open/dolphin/impl/scheam/resources/PolyLineOff.gif"))); // NOI18N
