...
public class KarteSettingPanel extends AbstractSettingPanel {
    ...
    class KarteModel {
        ...
        public void populate(ProjectStub stub) {
            ...
            setPdfStore(Project.getString(Project.LOCATION_PDF, ClientContext.getPDFDirectory()));  // stub.getPDFStore()
        ...
        public void restore(ProjectStub stub) {
            ...
            if (pdfDir != null && (!pdfDir.equals(""))) {
                Project.setString(Project.LOCATION_PDF, pdfDir);    //stub.setPDFStore(pdfDir);
            }
    ...
    public void restoreDefault() {
        ...
        //showModifiedCB.setSelected(Project.getDefaultBoolean(Project.DOC_HISTORY_SHOWMODIFIED));
