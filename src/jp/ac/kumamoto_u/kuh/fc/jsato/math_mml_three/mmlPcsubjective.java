...
public class mmlPcsubjective extends MMLObject {
	...
	public boolean buildEnd(String namespaceURI, String localName, String qName, MMLBuilder builder) {
		if (qName.equals("mmlPc:subjective") == true) {
			...
			if (parentElement.getQName().equals("mmlPc:problemItem")) {
				((mmlPcproblemItem)builder.getParent()).set_subjective((mmlPcsubjective)builder.getElement());
			}
	...
	/* setters and getters */
	public void set_freeNotes(mmlPcfreeNotes _freeNotes) {
		this._freeNotes = _freeNotes;
	}
	public mmlPcfreeNotes get_freeNotes() {
		return _freeNotes;
	}
	public void set_subjectiveItem(Vector _subjectiveItem) {
	...
	public Vector get_subjectiveItem() {
