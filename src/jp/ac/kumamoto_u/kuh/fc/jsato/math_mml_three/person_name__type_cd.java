 ...
 * @version
 */
public class person_name__type_cd extends MMLObject {
	...
	public boolean buildStart(String namespaceURI, String localName, String qName, Attributes atts, MMLBuilder builder) {
		if (qName.equals("person_name.type_cd") == true) {
			super.buildStart(namespaceURI,localName,qName,atts,builder);
			printlnStatus(parentElement.getQName() + " " + qName);
			
			/* create tree node */
			person_name__type_cd obj = new person_name__type_cd();
			builder.getMmlTree().addElement( obj );
			obj.setParentIndex( builder.mmlTreeIndex );
			builder.adjustIndex();
			((person_name__type_cd)builder.getElement()).setNamespace( getNamespace() );
			((person_name__type_cd)builder.getElement()).setLocalName( getLocalName() );
			((person_name__type_cd)builder.getElement()).setQName( getQName() );
			((person_name__type_cd)builder.getElement()).setAtts( getAtts() );/* :-) */
			/* atts */
			if (atts != null) {
				for (int i=0; i < atts.getLength(); ++i) {
					if ( ((String)atts.getQName(i)).equals("T") ) {
						set__T( atts.getValue(i) );
						((person_name__type_cd)builder.getElement()).set__T( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("NULL") ) {
						set__NULL( atts.getValue(i) );
						((person_name__type_cd)builder.getElement()).set__NULL( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("V") ) {
						set__V( atts.getValue(i) );
						((person_name__type_cd)builder.getElement()).set__V( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("V-T") ) {
						set__V_T( atts.getValue(i) );
						((person_name__type_cd)builder.getElement()).set__V_T( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("V-HL7_NAME") ) {
						set__V_HL7_NAME( atts.getValue(i) );
						((person_name__type_cd)builder.getElement()).set__V_HL7_NAME( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("DN") ) {
						set__DN( atts.getValue(i) );
						((person_name__type_cd)builder.getElement()).set__DN( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("DN-T") ) {
						set__DN_T( atts.getValue(i) );
						((person_name__type_cd)builder.getElement()).set__DN_T( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("DN-HL7_NAME") ) {
						set__DN_HL7_NAME( atts.getValue(i) );
						((person_name__type_cd)builder.getElement()).set__DN_HL7_NAME( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("S") ) {
						set__S( atts.getValue(i) );
						((person_name__type_cd)builder.getElement()).set__S( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("S-T") ) {
						set__S_T( atts.getValue(i) );
						((person_name__type_cd)builder.getElement()).set__S_T( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("S-HL7_NAME") ) {
						set__S_HL7_NAME( atts.getValue(i) );
						((person_name__type_cd)builder.getElement()).set__S_HL7_NAME( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("SN") ) {
						set__SN( atts.getValue(i) );
						((person_name__type_cd)builder.getElement()).set__SN( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("SN-T") ) {
						set__SN_T( atts.getValue(i) );
						((person_name__type_cd)builder.getElement()).set__SN_T( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("SN-HL7_NAME") ) {
						set__SN_HL7_NAME( atts.getValue(i) );
						((person_name__type_cd)builder.getElement()).set__SN_HL7_NAME( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("SV") ) {
						set__SV( atts.getValue(i) );
						((person_name__type_cd)builder.getElement()).set__SV( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("SV-T") ) {
						set__SV_T( atts.getValue(i) );
						((person_name__type_cd)builder.getElement()).set__SV_T( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("SV-HL7_NAME") ) {
						set__SV_HL7_NAME( atts.getValue(i) );
						((person_name__type_cd)builder.getElement()).set__SV_HL7_NAME( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("ORIGTXT") ) {
						set__ORIGTXT( atts.getValue(i) );
						((person_name__type_cd)builder.getElement()).set__ORIGTXT( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("ORIGTXT-T") ) {
						set__ORIGTXT_T( atts.getValue(i) );
						((person_name__type_cd)builder.getElement()).set__ORIGTXT_T( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("ORIGTXT-HL7_NAME") ) {
						set__ORIGTXT_HL7_NAME( atts.getValue(i) );
						((person_name__type_cd)builder.getElement()).set__ORIGTXT_HL7_NAME( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("VT") ) {
						set__VT( atts.getValue(i) );
						((person_name__type_cd)builder.getElement()).set__VT( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("VT-T") ) {
						set__VT_T( atts.getValue(i) );
						((person_name__type_cd)builder.getElement()).set__VT_T( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("VT-HL7_NAME") ) {
						set__VT_HL7_NAME( atts.getValue(i) );
						((person_name__type_cd)builder.getElement()).set__VT_HL7_NAME( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("PROB") ) {
						set__PROB( atts.getValue(i) );
						((person_name__type_cd)builder.getElement()).set__PROB( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("PROB-T") ) {
						set__PROB_T( atts.getValue(i) );
						((person_name__type_cd)builder.getElement()).set__PROB_T( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("PROB-HL7_NAME") ) {
						set__PROB_HL7_NAME( atts.getValue(i) );
						((person_name__type_cd)builder.getElement()).set__PROB_HL7_NAME( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("ID") ) {
						set__ID( atts.getValue(i) );
						((person_name__type_cd)builder.getElement()).set__ID( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("HL7-NAME") ) {
						set__HL7_NAME( atts.getValue(i) );
						((person_name__type_cd)builder.getElement()).set__HL7_NAME( atts.getValue(i) );
					}
				}
			}
	...
	public boolean buildEnd(String namespaceURI, String localName, String qName, MMLBuilder builder) {
		if (qName.equals("person_name.type_cd") == true) {
			...
			if (parentElement.getQName().equals("person_name")) {
				((person_name)builder.getParent()).set_person_name__type_cd((person_name__type_cd)builder.getElement());
			}
