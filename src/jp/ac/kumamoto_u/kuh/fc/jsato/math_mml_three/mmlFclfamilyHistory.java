...
public class mmlFclfamilyHistory extends MMLObject {
	...
	public boolean buildEnd(String namespaceURI, String localName, String qName, MMLBuilder builder) {
		if (qName.equals("mmlFcl:familyHistory") == true) {
			...
			if (parentElement.getQName().equals("mmlFcl:FirstClinicModule")) {
				((mmlFclFirstClinicModule)builder.getParent()).set_familyHistory((mmlFclfamilyHistory)builder.getElement());
			}
	...
	/* setters and getters */
	public void set_familyHistoryItem(Vector _familyHistoryItem) {
	...
	public Vector get_familyHistoryItem() {
