...
public class mmlLblaboratoryCenter extends MMLObject {
		...
		if (qName.equals("mmlLb:laboratoryCenter") == true) {
			...
			if (atts != null) {
				for (int i=0; i < atts.getLength(); ++i) {
					if ( ((String)atts.getQName(i)).equals("mmlLb:centerCode") ) {
						set__mmlLbcenterCode( atts.getValue(i) );
						((mmlLblaboratoryCenter)builder.getElement()).set__mmlLbcenterCode( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("mmlLb:centerCodeId") ) {
						set__mmlLbcenterCodeId( atts.getValue(i) );
						((mmlLblaboratoryCenter)builder.getElement()).set__mmlLbcenterCodeId( atts.getValue(i) );
					}
				}
			}
	...
	public boolean buildEnd(String namespaceURI, String localName, String qName, MMLBuilder builder) {
		if (qName.equals("mmlLb:laboratoryCenter") == true) {
			...
			if (parentElement.getQName().equals("mmlLb:information")) {
				((mmlLbinformation)builder.getParent()).set_laboratoryCenter((mmlLblaboratoryCenter)builder.getElement());
			}
	...
	/* setters and getters */
	public void set__mmlLbcenterCode(String __mmlLbcenterCode) {
		this.__mmlLbcenterCode = __mmlLbcenterCode;
	}
	public String get__mmlLbcenterCode() {
		return __mmlLbcenterCode;
	}
	public void set__mmlLbcenterCodeId(String __mmlLbcenterCodeId) {
		this.__mmlLbcenterCodeId = __mmlLbcenterCodeId;
	}
	public String get__mmlLbcenterCodeId() {
