 ...
 * @version
 */
public class ORIGTXT extends MMLObject {
	...
	public boolean buildEnd(String namespaceURI, String localName, String qName, MMLBuilder builder) {
		if (qName.equals("ORIGTXT") == true) {
			...
			if (parentElement.getQName().equals("TYPE")) {
				((TYPE)builder.getParent()).set_ORIGTXT((ORIGTXT)builder.getElement());
			}

			if (parentElement.getQName().equals("TRANSLTN")) {
				((TRANSLTN)builder.getParent()).set_ORIGTXT((ORIGTXT)builder.getElement());
			}

			if (parentElement.getQName().equals("service_target.type_cd")) {
				((service_target__type_cd)builder.getParent()).set_ORIGTXT((ORIGTXT)builder.getElement());
			}

			if (parentElement.getQName().equals("service_actor.type_cd")) {
				((service_actor__type_cd)builder.getParent()).set_ORIGTXT((ORIGTXT)builder.getElement());
			}

			if (parentElement.getQName().equals("responsibility.type_cd")) {
				((responsibility__type_cd)builder.getParent()).set_ORIGTXT((ORIGTXT)builder.getElement());
			}

			if (parentElement.getQName().equals("practice_setting_cd")) {
				((practice_setting_cd)builder.getParent()).set_ORIGTXT((ORIGTXT)builder.getElement());
			}

			if (parentElement.getQName().equals("person_name.type_cd")) {
				((person_name__type_cd)builder.getParent()).set_ORIGTXT((ORIGTXT)builder.getElement());
			}

			if (parentElement.getQName().equals("NOTE")) {
				((NOTE)builder.getParent()).set_ORIGTXT((ORIGTXT)builder.getElement());
			}

			if (parentElement.getQName().equals("NAME")) {
				((NAME)builder.getParent()).set_ORIGTXT((ORIGTXT)builder.getElement());
			}

			if (parentElement.getQName().equals("MODIFIER")) {
				((MODIFIER)builder.getParent()).set_ORIGTXT((ORIGTXT)builder.getElement());
			}

			if (parentElement.getQName().equals("function_cd")) {
				((function_cd)builder.getParent()).set_ORIGTXT((ORIGTXT)builder.getElement());
			}

			if (parentElement.getQName().equals("document_type_cd")) {
				((document_type_cd)builder.getParent()).set_ORIGTXT((ORIGTXT)builder.getElement());
			}

			if (parentElement.getQName().equals("confidentiality_cd")) {
				((confidentiality_cd)builder.getParent()).set_ORIGTXT((ORIGTXT)builder.getElement());
			}

			if (parentElement.getQName().equals("CONFID")) {
				((CONFID)builder.getParent()).set_ORIGTXT((ORIGTXT)builder.getElement());
			}

			if (parentElement.getQName().equals("coded_entry.value")) {
				((coded_entry__value)builder.getParent()).set_ORIGTXT((ORIGTXT)builder.getElement());
			}

			if (parentElement.getQName().equals("caption_cd")) {
				((caption_cd)builder.getParent()).set_ORIGTXT((ORIGTXT)builder.getElement());
			}

			if (parentElement.getQName().equals("administrative_gender_cd")) {
				((administrative_gender_cd)builder.getParent()).set_ORIGTXT((ORIGTXT)builder.getElement());
			}
	...
	public boolean characters(char[] ch, int start, int length, MMLBuilder builder) {
		if (builder.getCurrentElement().getQName().equals("ORIGTXT")) {
			StringBuffer buffer = new StringBuffer(length);
			buffer.append(ch, start, length);
			vt.addElement(buffer.toString());
			((ORIGTXT)builder.getElement()).getVt().addElement(buffer.toString());
