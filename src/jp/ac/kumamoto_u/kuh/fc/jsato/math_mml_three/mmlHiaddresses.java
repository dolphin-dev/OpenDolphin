	...
	public boolean buildEnd(String namespaceURI, String localName, String qName, MMLBuilder builder) {
		if (qName.equals("mmlHi:addresses") == true) {
			...
			if (parentElement.getQName().equals("mmlHi:workInfo")) {
				((mmlHiworkInfo)builder.getParent()).set_addresses((mmlHiaddresses)builder.getElement());
			}

			if (parentElement.getQName().equals("mmlHi:insuredInfo")) {
				((mmlHiinsuredInfo)builder.getParent()).set_addresses((mmlHiaddresses)builder.getElement());
			}

			if (parentElement.getQName().equals("mmlHi:clientInfo")) {
				((mmlHiclientInfo)builder.getParent()).set_addresses((mmlHiaddresses)builder.getElement());
			}
