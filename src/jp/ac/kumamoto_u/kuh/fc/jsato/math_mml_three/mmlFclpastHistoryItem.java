...
public class mmlFclpastHistoryItem extends MMLObject {
	...
	public boolean buildEnd(String namespaceURI, String localName, String qName, MMLBuilder builder) {
		if (qName.equals("mmlFcl:pastHistoryItem") == true) {
			...
			if (parentElement.getQName().equals("mmlFcl:pastHistory")) {
				Vector v = ((mmlFclpastHistory)builder.getParent()).get_pastHistoryItem();
	...
	/* setters and getters */
	public void set_timeExpression(mmlFcltimeExpression _timeExpression) {
		this._timeExpression = _timeExpression;
	}
	public mmlFcltimeExpression get_timeExpression() {
