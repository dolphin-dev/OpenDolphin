 ...
 * @version
 */
public class id extends MMLObject {
	...
	public boolean buildEnd(String namespaceURI, String localName, String qName, MMLBuilder builder) {
		if (qName.equals("id") == true) {
			...
			if (parentElement.getQName().equals("service_location")) {
				((service_location)builder.getParent()).set_id((id)builder.getElement());
			}

			if (parentElement.getQName().equals("related_document")) {
				((related_document)builder.getParent()).set_id((id)builder.getElement());
			}

			if (parentElement.getQName().equals("person")) {
				Vector v = ((person)builder.getParent()).get_id();
				v.addElement(builder.getElement());
			}

			if (parentElement.getQName().equals("patient_encounter")) {
				((patient_encounter)builder.getParent()).set_id((id)builder.getElement());
			}

			if (parentElement.getQName().equals("organization")) {
				Vector v = ((organization)builder.getParent()).get_id();
				v.addElement(builder.getElement());
			}

			if (parentElement.getQName().equals("order")) {
				((order)builder.getParent()).set_id((id)builder.getElement());
			}

			if (parentElement.getQName().equals("is_known_to")) {
				Vector v = ((is_known_to)builder.getParent()).get_id();
				v.addElement(builder.getElement());
			}

			if (parentElement.getQName().equals("is_known_by")) {
				Vector v = ((is_known_by)builder.getParent()).get_id();
				v.addElement(builder.getElement());
			}

			if (parentElement.getQName().equals("device")) {
				Vector v = ((device)builder.getParent()).get_id();
				v.addElement(builder.getElement());
			}

			if (parentElement.getQName().equals("clinical_document_header")) {
				((clinical_document_header)builder.getParent()).set_id((id)builder.getElement());
			}
