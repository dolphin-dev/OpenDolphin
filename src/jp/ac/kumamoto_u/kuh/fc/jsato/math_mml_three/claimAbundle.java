...
public class claimAbundle extends MMLObject {
		...
		if (qName.equals("claimA:bundle") == true) {
			...
			if (atts != null) {
				for (int i=0; i < atts.getLength(); ++i) {
					if ( ((String)atts.getQName(i)).equals("claimA:classCode") ) {
						set__claimAclassCode( atts.getValue(i) );
						((claimAbundle)builder.getElement()).set__claimAclassCode( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("claimA:classCodeId") ) {
						set__claimAclassCodeId( atts.getValue(i) );
						((claimAbundle)builder.getElement()).set__claimAclassCodeId( atts.getValue(i) );
					}
				}
			}
	...
	public boolean buildEnd(String namespaceURI, String localName, String qName, MMLBuilder builder) {
		if (qName.equals("claimA:bundle") == true) {
			...
			if (parentElement.getQName().equals("claimA:ClaimAmountModule")) {
				Vector v = ((claimAClaimAmountModule)builder.getParent()).get_bundle();
	...
	/* setters and getters */
	public void set__claimAclassCode(String __claimAclassCode) {
		this.__claimAclassCode = __claimAclassCode;
	}
	public String get__claimAclassCode() {
		return __claimAclassCode;
	}
	public void set__claimAclassCodeId(String __claimAclassCodeId) {
		this.__claimAclassCodeId = __claimAclassCodeId;
	}
	public String get__claimAclassCodeId() {
		return __claimAclassCodeId;
	}

	public void set_className(claimAclassName _className) {
		this._className = _className;
	}
	public claimAclassName get_className() {
		return _className;
	}
	public void set_claimBundlePoint(claimAclaimBundlePoint _claimBundlePoint) {
		this._claimBundlePoint = _claimBundlePoint;
	}
	public claimAclaimBundlePoint get_claimBundlePoint() {
		return _claimBundlePoint;
	}
	public void set_claimBundleRate(claimAclaimBundleRate _claimBundleRate) {
		this._claimBundleRate = _claimBundleRate;
	}
	public claimAclaimBundleRate get_claimBundleRate() {
		return _claimBundleRate;
	}
	public void set_administration(claimAadministration _administration) {
		this._administration = _administration;
	}
	public claimAadministration get_administration() {
		return _administration;
	}
	public void set_admMemo(claimAadmMemo _admMemo) {
		this._admMemo = _admMemo;
	}
	public claimAadmMemo get_admMemo() {
		return _admMemo;
	}
	public void set_bundleNumber(claimAbundleNumber _bundleNumber) {
		this._bundleNumber = _bundleNumber;
	}
	public claimAbundleNumber get_bundleNumber() {
		return _bundleNumber;
	}
	public void set_methodPoint(claimAmethodPoint _methodPoint) {
		this._methodPoint = _methodPoint;
	}
	public claimAmethodPoint get_methodPoint() {
		return _methodPoint;
	}
	public void set_materialPoint(claimAmaterialPoint _materialPoint) {
		this._materialPoint = _materialPoint;
	}
	public claimAmaterialPoint get_materialPoint() {
		return _materialPoint;
	}
	public void set_drugPoint(claimAdrugPoint _drugPoint) {
		this._drugPoint = _drugPoint;
	}
	public claimAdrugPoint get_drugPoint() {
		return _drugPoint;
	}
	public void set_ppsClass(claimAppsClass _ppsClass) {
		this._ppsClass = _ppsClass;
	}
	public claimAppsClass get_ppsClass() {
		return _ppsClass;
	}
