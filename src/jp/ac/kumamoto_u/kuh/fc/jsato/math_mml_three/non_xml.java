 ...
 * @version
 */
public class non_xml extends MMLObject {
	...
	public boolean buildEnd(String namespaceURI, String localName, String qName, MMLBuilder builder) {
		if (qName.equals("non_xml") == true) {
			...
			if (parentElement.getQName().equals("body")) {
				((body)builder.getParent()).set_non_xml((non_xml)builder.getElement());
			}
	...
	public boolean characters(char[] ch, int start, int length, MMLBuilder builder) {
		if (builder.getCurrentElement().getQName().equals("non_xml")) {
			StringBuffer buffer = new StringBuffer(length);
			buffer.append(ch, start, length);
			vt.addElement(buffer.toString());
			((non_xml)builder.getElement()).getVt().addElement(buffer.toString());
