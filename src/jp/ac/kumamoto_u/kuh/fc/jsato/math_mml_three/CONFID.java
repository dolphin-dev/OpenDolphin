 ...
 * @version
 */
public class CONFID extends MMLObject {
	...
	public boolean buildEnd(String namespaceURI, String localName, String qName, MMLBuilder builder) {
		if (qName.equals("CONFID") == true) {
			...
			if (parentElement.getQName().equals("THUMBNAIL")) {
				...
				v.addElement( (CONFID)builder.getElement() );
			}
			...
			if (parentElement.getQName().equals("ZIP")) {
				((ZIP)builder.getParent()).set_CONFID((CONFID)builder.getElement());
			}

			if (parentElement.getQName().equals("version_nbr")) {
				((version_nbr)builder.getParent()).set_CONFID((CONFID)builder.getElement());
			}

			if (parentElement.getQName().equals("TYPE")) {
				((TYPE)builder.getParent()).set_CONFID((CONFID)builder.getElement());
			}

			if (parentElement.getQName().equals("TRANSLTN")) {
				((TRANSLTN)builder.getParent()).set_CONFID((CONFID)builder.getElement());
			}

			if (parentElement.getQName().equals("transcriptionist.type_cd")) {
				((transcriptionist__type_cd)builder.getParent()).set_CONFID((CONFID)builder.getElement());
			}

			if (parentElement.getQName().equals("telecom")) {
				((telecom)builder.getParent()).set_CONFID((CONFID)builder.getElement());
			}

			if (parentElement.getQName().equals("STR")) {
				((STR)builder.getParent()).set_CONFID((CONFID)builder.getElement());
			}

			if (parentElement.getQName().equals("STA")) {
				((STA)builder.getParent()).set_CONFID((CONFID)builder.getElement());
			}

			if (parentElement.getQName().equals("signature_cd")) {
				((signature_cd)builder.getParent()).set_CONFID((CONFID)builder.getElement());
			}

			if (parentElement.getQName().equals("SFX")) {
				((SFX)builder.getParent()).set_CONFID((CONFID)builder.getElement());
			}

			if (parentElement.getQName().equals("set_id")) {
				((set_id)builder.getParent()).set_CONFID((CONFID)builder.getElement());
			}

			if (parentElement.getQName().equals("service_tmr")) {
				((service_tmr)builder.getParent()).set_CONFID((CONFID)builder.getElement());
			}

			if (parentElement.getQName().equals("service_target.type_cd")) {
				((service_target__type_cd)builder.getParent()).set_CONFID((CONFID)builder.getElement());
			}

			if (parentElement.getQName().equals("service_actor.type_cd")) {
				((service_actor__type_cd)builder.getParent()).set_CONFID((CONFID)builder.getElement());
			}

			if (parentElement.getQName().equals("responsibility.type_cd")) {
				((responsibility__type_cd)builder.getParent()).set_CONFID((CONFID)builder.getElement());
			}

			if (parentElement.getQName().equals("responsibility_tmr")) {
				((responsibility_tmr)builder.getParent()).set_CONFID((CONFID)builder.getElement());
			}

			if (parentElement.getQName().equals("REF")) {
				((REF)builder.getParent()).set_CONFID((CONFID)builder.getElement());
			}

			if (parentElement.getQName().equals("provider.type_cd")) {
				((provider__type_cd)builder.getParent()).set_CONFID((CONFID)builder.getElement());
			}

			if (parentElement.getQName().equals("practice_setting_cd")) {
				((practice_setting_cd)builder.getParent()).set_CONFID((CONFID)builder.getElement());
			}

			if (parentElement.getQName().equals("POB")) {
				((POB)builder.getParent()).set_CONFID((CONFID)builder.getElement());
			}

			if (parentElement.getQName().equals("PN.DEL")) {
				((PN__DEL)builder.getParent()).set_CONFID((CONFID)builder.getElement());
			}

			if (parentElement.getQName().equals("PFX")) {
				((PFX)builder.getParent()).set_CONFID((CONFID)builder.getElement());
			}

			if (parentElement.getQName().equals("person_name.type_cd")) {
				((person_name__type_cd)builder.getParent()).set_CONFID((CONFID)builder.getElement());
			}

			if (parentElement.getQName().equals("patient.type_cd")) {
				((patient__type_cd)builder.getParent()).set_CONFID((CONFID)builder.getElement());
			}

			if (parentElement.getQName().equals("participation_tmr")) {
				((participation_tmr)builder.getParent()).set_CONFID((CONFID)builder.getElement());
			}

			if (parentElement.getQName().equals("originator.type_cd")) {
				((originator__type_cd)builder.getParent()).set_CONFID((CONFID)builder.getElement());
			}

			if (parentElement.getQName().equals("origination_dttm")) {
				((origination_dttm)builder.getParent()).set_CONFID((CONFID)builder.getElement());
			}

			if (parentElement.getQName().equals("originating_organization.type_cd")) {
				((originating_organization__type_cd)builder.getParent()).set_CONFID((CONFID)builder.getElement());
			}

			if (parentElement.getQName().equals("originating_device.type_cd")) {
				((originating_device__type_cd)builder.getParent()).set_CONFID((CONFID)builder.getElement());
			}

			if (parentElement.getQName().equals("organization.nm")) {
				((organization__nm)builder.getParent()).set_CONFID((CONFID)builder.getElement());
			}

			if (parentElement.getQName().equals("observation_media.id")) {
				((observation_media__id)builder.getParent()).set_CONFID((CONFID)builder.getElement());
			}

			if (parentElement.getQName().equals("NUM")) {
				((NUM)builder.getParent()).set_CONFID((CONFID)builder.getElement());
			}

			if (parentElement.getQName().equals("NOTE")) {
				((NOTE)builder.getParent()).set_CONFID((CONFID)builder.getElement());
			}

			if (parentElement.getQName().equals("NAME")) {
				((NAME)builder.getParent()).set_CONFID((CONFID)builder.getElement());
			}

			if (parentElement.getQName().equals("MODIFIER")) {
				((MODIFIER)builder.getParent()).set_CONFID((CONFID)builder.getElement());
			}

			if (parentElement.getQName().equals("MID")) {
				((MID)builder.getParent()).set_CONFID((CONFID)builder.getElement());
			}

			if (parentElement.getQName().equals("LIT")) {
				((LIT)builder.getParent()).set_CONFID((CONFID)builder.getElement());
			}

			if (parentElement.getQName().equals("legal_authenticator.type_cd")) {
				((legal_authenticator__type_cd)builder.getParent()).set_CONFID((CONFID)builder.getElement());
			}

			if (parentElement.getQName().equals("intended_recipient.type_cd")) {
				((intended_recipient__type_cd)builder.getParent()).set_CONFID((CONFID)builder.getElement());
			}

			if (parentElement.getQName().equals("id")) {
				((id)builder.getParent()).set_CONFID((CONFID)builder.getElement());
			}

			if (parentElement.getQName().equals("HNR")) {
				((HNR)builder.getParent()).set_CONFID((CONFID)builder.getElement());
			}

			if (parentElement.getQName().equals("GIV")) {
				((GIV)builder.getParent()).set_CONFID((CONFID)builder.getElement());
			}

			if (parentElement.getQName().equals("function_cd")) {
				((function_cd)builder.getParent()).set_CONFID((CONFID)builder.getElement());
			}

			if (parentElement.getQName().equals("fulfills_order.type_cd")) {
				((fulfills_order__type_cd)builder.getParent()).set_CONFID((CONFID)builder.getElement());
			}

			if (parentElement.getQName().equals("FAM")) {
				((FAM)builder.getParent()).set_CONFID((CONFID)builder.getElement());
			}

			if (parentElement.getQName().equals("encounter_tmr")) {
				((encounter_tmr)builder.getParent()).set_CONFID((CONFID)builder.getElement());
			}

			if (parentElement.getQName().equals("effective_tmr")) {
				((effective_tmr)builder.getParent()).set_CONFID((CONFID)builder.getElement());
			}

			if (parentElement.getQName().equals("document_type_cd")) {
				((document_type_cd)builder.getParent()).set_CONFID((CONFID)builder.getElement());
			}

			if (parentElement.getQName().equals("document_relationship.type_cd")) {
				((document_relationship__type_cd)builder.getParent()).set_CONFID((CONFID)builder.getElement());
			}

			if (parentElement.getQName().equals("DIR")) {
				((DIR)builder.getParent()).set_CONFID((CONFID)builder.getElement());
			}

			if (parentElement.getQName().equals("DENOM")) {
				((DENOM)builder.getParent()).set_CONFID((CONFID)builder.getElement());
			}

			if (parentElement.getQName().equals("DEL")) {
				((DEL)builder.getParent()).set_CONFID((CONFID)builder.getElement());
			}

			if (parentElement.getQName().equals("CTY")) {
				((CTY)builder.getParent()).set_CONFID((CONFID)builder.getElement());
			}

			if (parentElement.getQName().equals("copy_dttm")) {
				((copy_dttm)builder.getParent()).set_CONFID((CONFID)builder.getElement());
			}

			if (parentElement.getQName().equals("confidentiality_cd")) {
				((confidentiality_cd)builder.getParent()).set_CONFID((CONFID)builder.getElement());
			}

			if (parentElement.getQName().equals("CONFID")) {
				((CONFID)builder.getParent()).set_CONFID((CONFID)builder.getElement());
			}

			if (parentElement.getQName().equals("coded_entry.value")) {
				((coded_entry__value)builder.getParent()).set_CONFID((CONFID)builder.getElement());
			}

			if (parentElement.getQName().equals("coded_entry.id")) {
				((coded_entry__id)builder.getParent()).set_CONFID((CONFID)builder.getElement());
			}

			if (parentElement.getQName().equals("CNT")) {
				((CNT)builder.getParent()).set_CONFID((CONFID)builder.getElement());
			}

			if (parentElement.getQName().equals("caption_cd")) {
				((caption_cd)builder.getParent()).set_CONFID((CONFID)builder.getElement());
			}

			if (parentElement.getQName().equals("birth_dttm")) {
				((birth_dttm)builder.getParent()).set_CONFID((CONFID)builder.getElement());
			}

			if (parentElement.getQName().equals("authenticator.type_cd")) {
				((authenticator__type_cd)builder.getParent()).set_CONFID((CONFID)builder.getElement());
			}

			if (parentElement.getQName().equals("administrative_gender_cd")) {
				((administrative_gender_cd)builder.getParent()).set_CONFID((CONFID)builder.getElement());
			}

			if (parentElement.getQName().equals("ADL")) {
				((ADL)builder.getParent()).set_CONFID((CONFID)builder.getElement());
			}
