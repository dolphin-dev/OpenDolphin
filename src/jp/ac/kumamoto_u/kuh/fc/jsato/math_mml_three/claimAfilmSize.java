...
public class claimAfilmSize extends MMLObject {
		...
		if (qName.equals("claimA:filmSize") == true) {
			...
			if (atts != null) {
				for (int i=0; i < atts.getLength(); ++i) {
					if ( ((String)atts.getQName(i)).equals("claimA:sizeCode") ) {
						set__claimAsizeCode( atts.getValue(i) );
						((claimAfilmSize)builder.getElement()).set__claimAsizeCode( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("claimA:sizeCodeId") ) {
						set__claimAsizeCodeId( atts.getValue(i) );
						((claimAfilmSize)builder.getElement()).set__claimAsizeCodeId( atts.getValue(i) );
					}
				}
			}
	...
	public boolean buildEnd(String namespaceURI, String localName, String qName, MMLBuilder builder) {
		if (qName.equals("claimA:filmSize") == true) {
			...
			if (parentElement.getQName().equals("claimA:film")) {
				((claimAfilm)builder.getParent()).set_filmSize((claimAfilmSize)builder.getElement());
			}
	...
	/* setters and getters */
	public void set__claimAsizeCode(String __claimAsizeCode) {
		this.__claimAsizeCode = __claimAsizeCode;
	}
	public String get__claimAsizeCode() {
		return __claimAsizeCode;
	}
	public void set__claimAsizeCodeId(String __claimAsizeCodeId) {
		this.__claimAsizeCodeId = __claimAsizeCodeId;
	}
	public String get__claimAsizeCodeId() {
