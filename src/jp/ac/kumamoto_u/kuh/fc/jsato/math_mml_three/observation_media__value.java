 ...
 * @version
 */
public class observation_media__value extends MMLObject {
	...
	public observation_media__value() {
	}
	...
	public boolean buildStart(String namespaceURI, String localName, String qName, Attributes atts, MMLBuilder builder) {
		if (qName.equals("observation_media.value") == true) {
			super.buildStart(namespaceURI,localName,qName,atts,builder);
			printlnStatus(parentElement.getQName() + " " + qName);
			
			/* create tree node */
			observation_media__value obj = new observation_media__value();
			builder.getMmlTree().addElement( obj );
			obj.setParentIndex( builder.mmlTreeIndex );
			builder.adjustIndex();
			((observation_media__value)builder.getElement()).setNamespace( getNamespace() );
			((observation_media__value)builder.getElement()).setLocalName( getLocalName() );
			((observation_media__value)builder.getElement()).setQName( getQName() );
			((observation_media__value)builder.getElement()).setAtts( getAtts() );/* :-) */
			/* atts */
			if (atts != null) {
				for (int i=0; i < atts.getLength(); ++i) {
					if ( ((String)atts.getQName(i)).equals("ID") ) {
						set__ID( atts.getValue(i) );
						((observation_media__value)builder.getElement()).set__ID( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("T") ) {
						set__T( atts.getValue(i) );
						((observation_media__value)builder.getElement()).set__T( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("NULL") ) {
						set__NULL( atts.getValue(i) );
						((observation_media__value)builder.getElement()).set__NULL( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("ENC") ) {
						set__ENC( atts.getValue(i) );
						((observation_media__value)builder.getElement()).set__ENC( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("MT") ) {
						set__MT( atts.getValue(i) );
						((observation_media__value)builder.getElement()).set__MT( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("MT-T") ) {
						set__MT_T( atts.getValue(i) );
						((observation_media__value)builder.getElement()).set__MT_T( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("MT-DOMAIN") ) {
						set__MT_DOMAIN( atts.getValue(i) );
						((observation_media__value)builder.getElement()).set__MT_DOMAIN( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("MT-HL7_NAME") ) {
						set__MT_HL7_NAME( atts.getValue(i) );
						((observation_media__value)builder.getElement()).set__MT_HL7_NAME( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("xml:lang") ) {
						set__xmllang( atts.getValue(i) );
						((observation_media__value)builder.getElement()).set__xmllang( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("xml:lang-T") ) {
						set__xmllang_T( atts.getValue(i) );
						((observation_media__value)builder.getElement()).set__xmllang_T( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("xml:lang-HL7_NAME") ) {
						set__xmllang_HL7_NAME( atts.getValue(i) );
						((observation_media__value)builder.getElement()).set__xmllang_HL7_NAME( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("COMPN") ) {
						set__COMPN( atts.getValue(i) );
						((observation_media__value)builder.getElement()).set__COMPN( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("COMPN-T") ) {
						set__COMPN_T( atts.getValue(i) );
						((observation_media__value)builder.getElement()).set__COMPN_T( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("COMPN-HL7_NAME") ) {
						set__COMPN_HL7_NAME( atts.getValue(i) );
						((observation_media__value)builder.getElement()).set__COMPN_HL7_NAME( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("COMPN-DOMAIN") ) {
						set__COMPN_DOMAIN( atts.getValue(i) );
						((observation_media__value)builder.getElement()).set__COMPN_DOMAIN( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("IC") ) {
						set__IC( atts.getValue(i) );
						((observation_media__value)builder.getElement()).set__IC( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("IC-T") ) {
						set__IC_T( atts.getValue(i) );
						((observation_media__value)builder.getElement()).set__IC_T( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("IC-HL7_NAME") ) {
						set__IC_HL7_NAME( atts.getValue(i) );
						((observation_media__value)builder.getElement()).set__IC_HL7_NAME( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("VT") ) {
						set__VT( atts.getValue(i) );
						((observation_media__value)builder.getElement()).set__VT( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("VT-T") ) {
						set__VT_T( atts.getValue(i) );
						((observation_media__value)builder.getElement()).set__VT_T( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("VT-HL7_NAME") ) {
						set__VT_HL7_NAME( atts.getValue(i) );
						((observation_media__value)builder.getElement()).set__VT_HL7_NAME( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("PROB") ) {
						set__PROB( atts.getValue(i) );
						((observation_media__value)builder.getElement()).set__PROB( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("PROB-T") ) {
						set__PROB_T( atts.getValue(i) );
						((observation_media__value)builder.getElement()).set__PROB_T( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("PROB-HL7_NAME") ) {
						set__PROB_HL7_NAME( atts.getValue(i) );
						((observation_media__value)builder.getElement()).set__PROB_HL7_NAME( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("HL7-NAME") ) {
						set__HL7_NAME( atts.getValue(i) );
						((observation_media__value)builder.getElement()).set__HL7_NAME( atts.getValue(i) );
					}
				}
			}
	...
	public boolean buildEnd(String namespaceURI, String localName, String qName, MMLBuilder builder) {
		if (qName.equals("observation_media.value") == true) {
			...
			if (parentElement.getQName().equals("observation_media")) {
				((observation_media)builder.getParent()).set_observation_media__value((observation_media__value)builder.getElement());
			}
	...
	public boolean characters(char[] ch, int start, int length, MMLBuilder builder) {
		if (builder.getCurrentElement().getQName().equals("observation_media.value")) {
			StringBuffer buffer = new StringBuffer(length);
			buffer.append(ch, start, length);
			vt.addElement(buffer.toString());
			((observation_media__value)builder.getElement()).getVt().addElement(buffer.toString());
