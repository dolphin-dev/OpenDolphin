...
public class mmlPiuniqueInfo extends MMLObject {
	...
	public boolean buildEnd(String namespaceURI, String localName, String qName, MMLBuilder builder) {
		if (qName.equals("mmlPi:uniqueInfo") == true) {
			...
			if (parentElement.getQName().equals("mmlPi:PatientModule")) {
				((mmlPiPatientModule)builder.getParent()).set_uniqueInfo((mmlPiuniqueInfo)builder.getElement());
			}
	...
	/* setters and getters */
	public void set_masterId(mmlPimasterId _masterId) {
		this._masterId = _masterId;
	}
	public mmlPimasterId get_masterId() {
		return _masterId;
	}
	public void set_otherId(Vector _otherId) {
