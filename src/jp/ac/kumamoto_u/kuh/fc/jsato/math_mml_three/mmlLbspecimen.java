...
public class mmlLbspecimen extends MMLObject {
	...
	public boolean buildEnd(String namespaceURI, String localName, String qName, MMLBuilder builder) {
		if (qName.equals("mmlLb:specimen") == true) {
			...
			if (parentElement.getQName().equals("mmlLb:laboTest")) {
				((mmlLblaboTest)builder.getParent()).set_specimen((mmlLbspecimen)builder.getElement());
			}
	...
	/* setters and getters */
	public void set_specimenName(mmlLbspecimenName _specimenName) {
		this._specimenName = _specimenName;
	}
	public mmlLbspecimenName get_specimenName() {
		return _specimenName;
	}
	public void set_spcMemo(Vector _spcMemo) {
	...
	public Vector get_spcMemo() {
		return _spcMemo;
	}
	public void set_spcMemoF(mmlLbspcMemoF _spcMemoF) {
		this._spcMemoF = _spcMemoF;
	}
	public mmlLbspcMemoF get_spcMemoF() {
		return _spcMemoF;
	}
