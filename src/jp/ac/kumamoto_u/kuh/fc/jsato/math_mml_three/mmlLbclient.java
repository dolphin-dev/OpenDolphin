...
public class mmlLbclient extends MMLObject {
		...
		if (qName.equals("mmlLb:client") == true) {
			...
			if (atts != null) {
				for (int i=0; i < atts.getLength(); ++i) {
					if ( ((String)atts.getQName(i)).equals("mmlLb:clientCode") ) {
						set__mmlLbclientCode( atts.getValue(i) );
						((mmlLbclient)builder.getElement()).set__mmlLbclientCode( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("mmlLb:clientCodeId") ) {
						set__mmlLbclientCodeId( atts.getValue(i) );
						((mmlLbclient)builder.getElement()).set__mmlLbclientCodeId( atts.getValue(i) );
					}
				}
			}
	...
	public boolean buildEnd(String namespaceURI, String localName, String qName, MMLBuilder builder) {
		if (qName.equals("mmlLb:client") == true) {
			...
			if (parentElement.getQName().equals("mmlLb:information")) {
				((mmlLbinformation)builder.getParent()).set_client((mmlLbclient)builder.getElement());
			}
	...
	/* setters and getters */
	public void set__mmlLbclientCode(String __mmlLbclientCode) {
		this.__mmlLbclientCode = __mmlLbclientCode;
	}
	public String get__mmlLbclientCode() {
		return __mmlLbclientCode;
	}
	public void set__mmlLbclientCodeId(String __mmlLbclientCodeId) {
		this.__mmlLbclientCodeId = __mmlLbclientCodeId;
	}
	public String get__mmlLbclientCodeId() {
