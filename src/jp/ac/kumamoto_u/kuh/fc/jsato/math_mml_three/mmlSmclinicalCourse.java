...
public class mmlSmclinicalCourse extends MMLObject {
	...
	public boolean buildEnd(String namespaceURI, String localName, String qName, MMLBuilder builder) {
		if (qName.equals("mmlSm:clinicalCourse") == true) {
			...
			if (parentElement.getQName().equals("mmlSm:SummaryModule")) {
				((mmlSmSummaryModule)builder.getParent()).set_clinicalCourse((mmlSmclinicalCourse)builder.getElement());
			}

			if (parentElement.getQName().equals("mmlRe:ReferralModule")) {
				((mmlReReferralModule)builder.getParent()).set_clinicalCourse((mmlSmclinicalCourse)builder.getElement());
			}
	...
	/* setters and getters */
	public void set_clinicalRecord(Vector _clinicalRecord) {
	...
	public Vector get_clinicalRecord() {
