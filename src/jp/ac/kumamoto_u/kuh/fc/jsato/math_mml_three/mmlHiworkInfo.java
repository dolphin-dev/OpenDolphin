 ...
 * @version
 */
public class mmlHiworkInfo extends MMLObject {
	...
	public boolean buildStart(String namespaceURI, String localName, String qName, Attributes atts, MMLBuilder builder) {
		if (qName.equals("mmlHi:workInfo") == true) {
			super.buildStart(namespaceURI,localName,qName,atts,builder);
			printlnStatus(parentElement.getQName() + " " + qName);
			
			/* create tree node */
			mmlHiworkInfo obj = new mmlHiworkInfo();
			builder.getMmlTree().addElement( obj );
			obj.setParentIndex( builder.mmlTreeIndex );
			builder.adjustIndex();
			((mmlHiworkInfo)builder.getElement()).setNamespace( getNamespace() );
			((mmlHiworkInfo)builder.getElement()).setLocalName( getLocalName() );
			((mmlHiworkInfo)builder.getElement()).setQName( getQName() );
			((mmlHiworkInfo)builder.getElement()).setAtts( getAtts() );/* :-) */
			/* atts */
	...
	public boolean buildEnd(String namespaceURI, String localName, String qName, MMLBuilder builder) {
		if (qName.equals("mmlHi:workInfo") == true) {
			...
			if (parentElement.getQName().equals("mmlHi:HealthInsuranceModule")) {
				((mmlHiHealthInsuranceModule)builder.getParent()).set_workInfo((mmlHiworkInfo)builder.getElement());
			}
