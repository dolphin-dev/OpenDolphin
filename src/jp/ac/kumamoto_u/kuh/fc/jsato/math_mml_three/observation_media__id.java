 ...
 * @version
 */
public class observation_media__id extends MMLObject {
	...
	public boolean buildStart(String namespaceURI, String localName, String qName, Attributes atts, MMLBuilder builder) {
		if (qName.equals("observation_media.id") == true) {
			super.buildStart(namespaceURI,localName,qName,atts,builder);
			printlnStatus(parentElement.getQName() + " " + qName);
			
			/* create tree node */
			observation_media__id obj = new observation_media__id();
			builder.getMmlTree().addElement( obj );
			obj.setParentIndex( builder.mmlTreeIndex );
			builder.adjustIndex();
			((observation_media__id)builder.getElement()).setNamespace( getNamespace() );
			((observation_media__id)builder.getElement()).setLocalName( getLocalName() );
			((observation_media__id)builder.getElement()).setQName( getQName() );
			((observation_media__id)builder.getElement()).setAtts( getAtts() );/* :-) */
			/* atts */
			if (atts != null) {
				for (int i=0; i < atts.getLength(); ++i) {
					if ( ((String)atts.getQName(i)).equals("ID") ) {
						set__ID( atts.getValue(i) );
						((observation_media__id)builder.getElement()).set__ID( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("T") ) {
						set__T( atts.getValue(i) );
						((observation_media__id)builder.getElement()).set__T( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("NULL") ) {
						set__NULL( atts.getValue(i) );
						((observation_media__id)builder.getElement()).set__NULL( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("EX") ) {
						set__EX( atts.getValue(i) );
						((observation_media__id)builder.getElement()).set__EX( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("EX-T") ) {
						set__EX_T( atts.getValue(i) );
						((observation_media__id)builder.getElement()).set__EX_T( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("EX-HL7_NAME") ) {
						set__EX_HL7_NAME( atts.getValue(i) );
						((observation_media__id)builder.getElement()).set__EX_HL7_NAME( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("RT") ) {
						set__RT( atts.getValue(i) );
						((observation_media__id)builder.getElement()).set__RT( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("RT-T") ) {
						set__RT_T( atts.getValue(i) );
						((observation_media__id)builder.getElement()).set__RT_T( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("RT-HL7_NAME") ) {
						set__RT_HL7_NAME( atts.getValue(i) );
						((observation_media__id)builder.getElement()).set__RT_HL7_NAME( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("AAN") ) {
						set__AAN( atts.getValue(i) );
						((observation_media__id)builder.getElement()).set__AAN( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("AAN-T") ) {
						set__AAN_T( atts.getValue(i) );
						((observation_media__id)builder.getElement()).set__AAN_T( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("AAN-HL7_NAME") ) {
						set__AAN_HL7_NAME( atts.getValue(i) );
						((observation_media__id)builder.getElement()).set__AAN_HL7_NAME( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("VT") ) {
						set__VT( atts.getValue(i) );
						((observation_media__id)builder.getElement()).set__VT( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("VT-T") ) {
						set__VT_T( atts.getValue(i) );
						((observation_media__id)builder.getElement()).set__VT_T( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("VT-HL7_NAME") ) {
						set__VT_HL7_NAME( atts.getValue(i) );
						((observation_media__id)builder.getElement()).set__VT_HL7_NAME( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("PROB") ) {
						set__PROB( atts.getValue(i) );
						((observation_media__id)builder.getElement()).set__PROB( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("PROB-T") ) {
						set__PROB_T( atts.getValue(i) );
						((observation_media__id)builder.getElement()).set__PROB_T( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("PROB-HL7_NAME") ) {
						set__PROB_HL7_NAME( atts.getValue(i) );
						((observation_media__id)builder.getElement()).set__PROB_HL7_NAME( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("HL7-NAME") ) {
						set__HL7_NAME( atts.getValue(i) );
						((observation_media__id)builder.getElement()).set__HL7_NAME( atts.getValue(i) );
					}
				}
			}
	...
	public boolean buildEnd(String namespaceURI, String localName, String qName, MMLBuilder builder) {
		if (qName.equals("observation_media.id") == true) {
			...
			if (parentElement.getQName().equals("observation_media")) {
				((observation_media)builder.getParent()).set_observation_media__id((observation_media__id)builder.getElement());
			}
