	...
	public boolean buildEnd(String namespaceURI, String localName, String qName, MMLBuilder builder) {
		if (qName.equals("mmlFc:Facility") == true) {
			...
			if (parentElement.getQName().equals("mmlRe:referToFacility")) {
				((mmlRereferToFacility)builder.getParent()).set_Facility((mmlFcFacility)builder.getElement());
			}

			if (parentElement.getQName().equals("mmlPsi:PersonalizedInfo")) {
				((mmlPsiPersonalizedInfo)builder.getParent()).set_Facility((mmlFcFacility)builder.getElement());
			}

			if (parentElement.getQName().equals("mmlHi:facility")) {
				((mmlHifacility)builder.getParent()).set_Facility((mmlFcFacility)builder.getElement());
			}

			if (parentElement.getQName().equals("mmlFcl:birthInfo")) {
				((mmlFclbirthInfo)builder.getParent()).set_Facility((mmlFcFacility)builder.getElement());
			}
