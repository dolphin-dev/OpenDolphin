 ...
 * @version
 */
public class PN__DEL extends MMLObject {
	...
	public boolean buildStart(String namespaceURI, String localName, String qName, Attributes atts, MMLBuilder builder) {
		if (qName.equals("PN.DEL") == true) {
			super.buildStart(namespaceURI,localName,qName,atts,builder);
			printlnStatus(parentElement.getQName() + " " + qName);
			
			/* create tree node */
			PN__DEL obj = new PN__DEL();
			builder.getMmlTree().addElement( obj );
			obj.setParentIndex( builder.mmlTreeIndex );
			builder.adjustIndex();
			((PN__DEL)builder.getElement()).setNamespace( getNamespace() );
			((PN__DEL)builder.getElement()).setLocalName( getLocalName() );
			((PN__DEL)builder.getElement()).setQName( getQName() );
			((PN__DEL)builder.getElement()).setAtts( getAtts() );/* :-) */
			/* atts */
			if (atts != null) {
				for (int i=0; i < atts.getLength(); ++i) {
					if ( ((String)atts.getQName(i)).equals("T") ) {
						set__T( atts.getValue(i) );
						((PN__DEL)builder.getElement()).set__T( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("NULL") ) {
						set__NULL( atts.getValue(i) );
						((PN__DEL)builder.getElement()).set__NULL( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("V") ) {
						set__V( atts.getValue(i) );
						((PN__DEL)builder.getElement()).set__V( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("V-T") ) {
						set__V_T( atts.getValue(i) );
						((PN__DEL)builder.getElement()).set__V_T( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("V-HL7_NAME") ) {
						set__V_HL7_NAME( atts.getValue(i) );
						((PN__DEL)builder.getElement()).set__V_HL7_NAME( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("QUAL") ) {
						set__QUAL( atts.getValue(i) );
						((PN__DEL)builder.getElement()).set__QUAL( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("QUAL-T") ) {
						set__QUAL_T( atts.getValue(i) );
						((PN__DEL)builder.getElement()).set__QUAL_T( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("QUAL-DOMAIN") ) {
						set__QUAL_DOMAIN( atts.getValue(i) );
						((PN__DEL)builder.getElement()).set__QUAL_DOMAIN( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("QUAL-HL7_NAME") ) {
						set__QUAL_HL7_NAME( atts.getValue(i) );
						((PN__DEL)builder.getElement()).set__QUAL_HL7_NAME( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("VT") ) {
						set__VT( atts.getValue(i) );
						((PN__DEL)builder.getElement()).set__VT( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("VT-T") ) {
						set__VT_T( atts.getValue(i) );
						((PN__DEL)builder.getElement()).set__VT_T( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("VT-HL7_NAME") ) {
						set__VT_HL7_NAME( atts.getValue(i) );
						((PN__DEL)builder.getElement()).set__VT_HL7_NAME( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("PROB") ) {
						set__PROB( atts.getValue(i) );
						((PN__DEL)builder.getElement()).set__PROB( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("PROB-T") ) {
						set__PROB_T( atts.getValue(i) );
						((PN__DEL)builder.getElement()).set__PROB_T( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("PROB-HL7_NAME") ) {
						set__PROB_HL7_NAME( atts.getValue(i) );
						((PN__DEL)builder.getElement()).set__PROB_HL7_NAME( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("HL7_NAME") ) {
						set__HL7_NAME( atts.getValue(i) );
						((PN__DEL)builder.getElement()).set__HL7_NAME( atts.getValue(i) );
					}
				}
			}
