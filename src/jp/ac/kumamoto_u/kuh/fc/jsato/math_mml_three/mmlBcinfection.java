...
public class mmlBcinfection extends MMLObject {
	...
	public boolean buildEnd(String namespaceURI, String localName, String qName, MMLBuilder builder) {
		if (qName.equals("mmlBc:infection") == true) {
			...
			if (parentElement.getQName().equals("mmlBc:BaseClinicModule")) {
				((mmlBcBaseClinicModule)builder.getParent()).set_infection((mmlBcinfection)builder.getElement());
			}
	...
	/* setters and getters */
	public void set_infectionItem(Vector _infectionItem) {
	...
	public Vector get_infectionItem() {
