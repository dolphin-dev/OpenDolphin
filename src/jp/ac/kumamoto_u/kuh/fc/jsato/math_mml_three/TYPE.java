 ...
 * @version
 */
public class TYPE extends MMLObject {
	...
	public boolean buildEnd(String namespaceURI, String localName, String qName, MMLBuilder builder) {
		if (qName.equals("TYPE") == true) {
			...
			if (parentElement.getQName().equals("set_id")) {
				((set_id)builder.getParent()).set_TYPE((TYPE)builder.getElement());
			}

			if (parentElement.getQName().equals("observation_media.id")) {
				((observation_media__id)builder.getParent()).set_TYPE((TYPE)builder.getElement());
			}

			if (parentElement.getQName().equals("id")) {
				((id)builder.getParent()).set_TYPE((TYPE)builder.getElement());
			}

			if (parentElement.getQName().equals("coded_entry.id")) {
				((coded_entry__id)builder.getParent()).set_TYPE((TYPE)builder.getElement());
			}
