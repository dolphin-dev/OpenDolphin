...
public class mmlBcallergy extends MMLObject {
	...
	public boolean buildEnd(String namespaceURI, String localName, String qName, MMLBuilder builder) {
		if (qName.equals("mmlBc:allergy") == true) {
			...
			if (parentElement.getQName().equals("mmlBc:BaseClinicModule")) {
				((mmlBcBaseClinicModule)builder.getParent()).set_allergy((mmlBcallergy)builder.getElement());
			}
	...
	/* setters and getters */
	public void set_allergyItem(Vector _allergyItem) {
