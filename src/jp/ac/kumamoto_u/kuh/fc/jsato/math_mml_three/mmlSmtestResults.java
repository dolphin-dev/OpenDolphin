...
public class mmlSmtestResults extends MMLObject {
	...
	public boolean buildEnd(String namespaceURI, String localName, String qName, MMLBuilder builder) {
		if (qName.equals("mmlSm:testResults") == true) {
			...
			if (parentElement.getQName().equals("mmlSm:SummaryModule")) {
				((mmlSmSummaryModule)builder.getParent()).set_testResults((mmlSmtestResults)builder.getElement());
			}
	...
	/* setters and getters */
	public void set_testResult(Vector _testResult) {
