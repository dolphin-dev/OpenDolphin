...
public class mmlSgsurgicalDepartment extends MMLObject {
	...
	public boolean buildEnd(String namespaceURI, String localName, String qName, MMLBuilder builder) {
		if (qName.equals("mmlSg:surgicalDepartment") == true) {
			...
			if (parentElement.getQName().equals("mmlSg:surgicalInfo")) {
				((mmlSgsurgicalInfo)builder.getParent()).set_surgicalDepartment((mmlSgsurgicalDepartment)builder.getElement());
			}
	...
	/* setters and getters */
	public void set_Department(Vector _Department) {
