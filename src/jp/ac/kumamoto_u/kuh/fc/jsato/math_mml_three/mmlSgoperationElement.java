...
public class mmlSgoperationElement extends MMLObject {
	...
	public boolean buildEnd(String namespaceURI, String localName, String qName, MMLBuilder builder) {
		if (qName.equals("mmlSg:operationElement") == true) {
			...
			if (parentElement.getQName().equals("mmlSg:procedureItem")) {
				((mmlSgprocedureItem)builder.getParent()).set_operationElement((mmlSgoperationElement)builder.getElement());
			}
	...
	/* setters and getters */
	public void set_operationElementItem(Vector _operationElementItem) {
	...
	public Vector get_operationElementItem() {
