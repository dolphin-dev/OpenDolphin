...
public class mmlSminPatient extends MMLObject {
	...
	public boolean buildEnd(String namespaceURI, String localName, String qName, MMLBuilder builder) {
		if (qName.equals("mmlSm:inPatient") == true) {
			...
			if (parentElement.getQName().equals("mmlSm:serviceHistory")) {
				((mmlSmserviceHistory)builder.getParent()).set_inPatient((mmlSminPatient)builder.getElement());
			}
	...
	/* setters and getters */
	public void set_inPatientItem(Vector _inPatientItem) {
	...
	public Vector get_inPatientItem() {
