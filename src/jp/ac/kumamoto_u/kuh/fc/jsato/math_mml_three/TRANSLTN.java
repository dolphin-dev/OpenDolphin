 ...
 * @version
 */
public class TRANSLTN extends MMLObject {
	...
	public boolean buildEnd(String namespaceURI, String localName, String qName, MMLBuilder builder) {
		if (qName.equals("TRANSLTN") == true) {
			...
			if (parentElement.getQName().equals("TRANSLTN")) {
				Vector v = ((TRANSLTN)builder.getParent()).get_TRANSLTN();
				v.addElement(builder.getElement());
			}

			if (parentElement.getQName().equals("service_target.type_cd")) {
				Vector v = ((service_target__type_cd)builder.getParent()).get_TRANSLTN();
				v.addElement(builder.getElement());
			}

			if (parentElement.getQName().equals("service_actor.type_cd")) {
				Vector v = ((service_actor__type_cd)builder.getParent()).get_TRANSLTN();
				v.addElement(builder.getElement());
			}

			if (parentElement.getQName().equals("responsibility.type_cd")) {
				Vector v = ((responsibility__type_cd)builder.getParent()).get_TRANSLTN();
				v.addElement(builder.getElement());
			}

			if (parentElement.getQName().equals("practice_setting_cd")) {
				Vector v = ((practice_setting_cd)builder.getParent()).get_TRANSLTN();
				v.addElement(builder.getElement());
			}

			if (parentElement.getQName().equals("person_name.type_cd")) {
				Vector v = ((person_name__type_cd)builder.getParent()).get_TRANSLTN();
				v.addElement(builder.getElement());
			}

			if (parentElement.getQName().equals("NOTE")) {
				Vector v = ((NOTE)builder.getParent()).get_TRANSLTN();
				v.addElement(builder.getElement());
			}

			if (parentElement.getQName().equals("MODIFIER")) {
				Vector v = ((MODIFIER)builder.getParent()).get_TRANSLTN();
				v.addElement(builder.getElement());
			}

			if (parentElement.getQName().equals("function_cd")) {
				Vector v = ((function_cd)builder.getParent()).get_TRANSLTN();
				v.addElement(builder.getElement());
			}

			if (parentElement.getQName().equals("document_type_cd")) {
				Vector v = ((document_type_cd)builder.getParent()).get_TRANSLTN();
				v.addElement(builder.getElement());
			}

			if (parentElement.getQName().equals("confidentiality_cd")) {
				Vector v = ((confidentiality_cd)builder.getParent()).get_TRANSLTN();
				v.addElement(builder.getElement());
			}

			if (parentElement.getQName().equals("coded_entry.value")) {
				Vector v = ((coded_entry__value)builder.getParent()).get_TRANSLTN();
				v.addElement(builder.getElement());
			}

			if (parentElement.getQName().equals("caption_cd")) {
				Vector v = ((caption_cd)builder.getParent()).get_TRANSLTN();
				v.addElement(builder.getElement());
			}

			if (parentElement.getQName().equals("administrative_gender_cd")) {
				Vector v = ((administrative_gender_cd)builder.getParent()).get_TRANSLTN();
				v.addElement(builder.getElement());
			}
