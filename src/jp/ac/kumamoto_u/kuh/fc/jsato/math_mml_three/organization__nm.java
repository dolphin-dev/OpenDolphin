 ...
 * @version
 */
public class organization__nm extends MMLObject {
	...
	private String __TYPE_T = null;
	private String __TYPE_DOMAIN = null;
	private String __TYPE_HL7_NAME = null;
	...
	public void printObject(PrintWriter pw, MMLVisitor visitor) throws IOException {
		if ( this.getQName() != null ) {
			...
			if ( __TYPE_T != null ) pw.print(" " + "TYPE-T" +  "=" + "'" + __TYPE_T + "'");
			if ( __TYPE_DOMAIN != null ) pw.print(" " + "TYPE-DOMAIN" +  "=" + "'" + __TYPE_DOMAIN + "'");
			if ( __TYPE_HL7_NAME != null ) pw.print(" " + "TYPE-HL7_NAME" +  "=" + "'" + __TYPE_HL7_NAME + "'");
	...
	public boolean buildStart(String namespaceURI, String localName, String qName, Attributes atts, MMLBuilder builder) {
		if (qName.equals("organization.nm") == true) {
			super.buildStart(namespaceURI,localName,qName,atts,builder);
			printlnStatus(parentElement.getQName() + " " + qName);
			
			/* create tree node */
			organization__nm obj = new organization__nm();
			builder.getMmlTree().addElement( obj );
			obj.setParentIndex( builder.mmlTreeIndex );
			builder.adjustIndex();
			((organization__nm)builder.getElement()).setNamespace( getNamespace() );
			((organization__nm)builder.getElement()).setLocalName( getLocalName() );
			((organization__nm)builder.getElement()).setQName( getQName() );
			((organization__nm)builder.getElement()).setAtts( getAtts() );/* :-) */
			/* atts */
			if (atts != null) {
				for (int i=0; i < atts.getLength(); ++i) {
					if ( ((String)atts.getQName(i)).equals("T") ) {
						set__T( atts.getValue(i) );
						((organization__nm)builder.getElement()).set__T( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("NULL") ) {
						set__NULL( atts.getValue(i) );
						((organization__nm)builder.getElement()).set__NULL( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("V") ) {
						set__V( atts.getValue(i) );
						((organization__nm)builder.getElement()).set__V( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("V-T") ) {
						set__V_T( atts.getValue(i) );
						((organization__nm)builder.getElement()).set__V_T( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("V-HL7_NAME") ) {
						set__V_HL7_NAME( atts.getValue(i) );
						((organization__nm)builder.getElement()).set__V_HL7_NAME( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("TYPE") ) {
						set__TYPE( atts.getValue(i) );
						((organization__nm)builder.getElement()).set__TYPE( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("TYPE-T") ) {
						set__TYPE_T( atts.getValue(i) );
						((organization__nm)builder.getElement()).set__TYPE_T( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("TYPE-DOMAIN") ) {
						set__TYPE_DOMAIN( atts.getValue(i) );
						((organization__nm)builder.getElement()).set__TYPE_DOMAIN( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("TYPE-HL7_NAME") ) {
						set__TYPE_HL7_NAME( atts.getValue(i) );
						((organization__nm)builder.getElement()).set__TYPE_HL7_NAME( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("VT") ) {
						set__VT( atts.getValue(i) );
						((organization__nm)builder.getElement()).set__VT( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("VT-T") ) {
						set__VT_T( atts.getValue(i) );
						((organization__nm)builder.getElement()).set__VT_T( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("VT-HL7_NAME") ) {
						set__VT_HL7_NAME( atts.getValue(i) );
						((organization__nm)builder.getElement()).set__VT_HL7_NAME( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("PROB") ) {
						set__PROB( atts.getValue(i) );
						((organization__nm)builder.getElement()).set__PROB( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("PROB-T") ) {
						set__PROB_T( atts.getValue(i) );
						((organization__nm)builder.getElement()).set__PROB_T( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("PROB-HL7_NAME") ) {
						set__PROB_HL7_NAME( atts.getValue(i) );
						((organization__nm)builder.getElement()).set__PROB_HL7_NAME( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("ID") ) {
						set__ID( atts.getValue(i) );
						((organization__nm)builder.getElement()).set__ID( atts.getValue(i) );
					}
					if ( ((String)atts.getQName(i)).equals("HL7-NAME") ) {
						set__HL7_NAME( atts.getValue(i) );
						((organization__nm)builder.getElement()).set__HL7_NAME( atts.getValue(i) );
					}
				}
			}
	...
	public boolean buildEnd(String namespaceURI, String localName, String qName, MMLBuilder builder) {
		if (qName.equals("organization.nm") == true) {
			...
			if (parentElement.getQName().equals("organization")) {
				Vector v = ((organization)builder.getParent()).get_organization__nm();
	...
	public void set__TYPE_T(String __TYPE_T) {
		this.__TYPE_T = __TYPE_T;
	}
	public String get__TYPE_T() {
		return __TYPE_T;
	}
	public void set__TYPE_DOMAIN(String __TYPE_DOMAIN) {
		this.__TYPE_DOMAIN = __TYPE_DOMAIN;
	}
	public String get__TYPE_DOMAIN() {
		return __TYPE_DOMAIN;
	}
	public void set__TYPE_HL7_NAME(String __TYPE_HL7_NAME) {
		this.__TYPE_HL7_NAME = __TYPE_HL7_NAME;
	}
	public String get__TYPE_HL7_NAME() {
		return __TYPE_HL7_NAME;
	}
