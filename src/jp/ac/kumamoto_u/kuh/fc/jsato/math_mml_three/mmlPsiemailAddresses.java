...
public class mmlPsiemailAddresses extends MMLObject {
	...
	public boolean buildEnd(String namespaceURI, String localName, String qName, MMLBuilder builder) {
		if (qName.equals("mmlPsi:emailAddresses") == true) {
			...
			if (parentElement.getQName().equals("mmlPsi:PersonalizedInfo")) {
				((mmlPsiPersonalizedInfo)builder.getParent()).set_emailAddresses((mmlPsiemailAddresses)builder.getElement());
			}
	...
	/* setters and getters */
	public void set_email(Vector _email) {
