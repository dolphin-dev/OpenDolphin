...
public class mmlSgsurgicalProcedure extends MMLObject {
	...
	public boolean buildEnd(String namespaceURI, String localName, String qName, MMLBuilder builder) {
		if (qName.equals("mmlSg:surgicalProcedure") == true) {
			...
			if (parentElement.getQName().equals("mmlSg:surgeryItem")) {
				((mmlSgsurgeryItem)builder.getParent()).setSurgicalProcedure((mmlSgsurgicalProcedure)builder.getElement());
			}
	...
	/* setters and getters */
	public void setProcedureItem(Vector _procedureItem) {
	...
	public Vector getProcedureItem() {
