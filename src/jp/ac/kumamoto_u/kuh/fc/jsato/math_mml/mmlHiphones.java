	...
	public boolean buildEnd(String namespaceURI, String localName, String qName, MMLBuilder builder) {
		if (qName.equals("mmlHi:phones") == true) {
			...
			if (parentElement.getQName().equals("mmlHi:workInfo")) {
				((mmlHiworkInfo)builder.getParent()).setPhones((mmlHiphones)builder.getElement());
			}

			if (parentElement.getQName().equals("mmlHi:insuredInfo")) {
				((mmlHiinsuredInfo)builder.getParent()).setPhones((mmlHiphones)builder.getElement());
			}

			if (parentElement.getQName().equals("mmlHi:clientInfo")) {
				((mmlHiclientInfo)builder.getParent()).setPhones((mmlHiphones)builder.getElement());
			}
