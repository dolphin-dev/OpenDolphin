...
public class mmlScfacility extends MMLObject {
	...
	public boolean buildEnd(String namespaceURI, String localName, String qName, MMLBuilder builder) {
		if (qName.equals("mmlSc:facility") == true) {
			...
			if (parentElement.getQName().equals("accessRight")) {
				((accessRight)builder.getParent()).setFacility((mmlScfacility)builder.getElement());
			}
	...
	/* setters and getters */
	public void setFacilityName(Vector _facilityName) {
