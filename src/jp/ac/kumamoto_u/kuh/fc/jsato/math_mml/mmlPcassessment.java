...
public class mmlPcassessment extends MMLObject {
	...
	public boolean buildEnd(String namespaceURI, String localName, String qName, MMLBuilder builder) {
		if (qName.equals("mmlPc:assessment") == true) {
			...
			if (parentElement.getQName().equals("mmlPc:problemItem")) {
				((mmlPcproblemItem)builder.getParent()).setAssessment((mmlPcassessment)builder.getElement());
			}
	...
	/* setters and getters */
	public void setAssessmentItem(Vector _assessmentItem) {
	...
	public Vector getAssessmentItem() {
