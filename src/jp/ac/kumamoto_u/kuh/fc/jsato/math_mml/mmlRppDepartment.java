	...
	public boolean buildStart(String namespaceURI, String localName, String qName, Attributes atts, MMLBuilder builder) {
		if (qName.equals("mmlRp:pDepartment") == true) {
			...
			if (atts != null) {
				...
				((mmlRppDepartment)builder.getElement()).setMmlRpdepCode( atts.getValue(namespaceURI, "depCode") );
				setMmlRpdepCodeId( atts.getValue(namespaceURI, "depCodeId") );
				((mmlRppDepartment)builder.getElement()).setMmlRpdepCodeId( atts.getValue(namespaceURI, "depCodeId") );
			}
	...
	public boolean buildEnd(String namespaceURI, String localName, String qName, MMLBuilder builder) {
		if (qName.equals("mmlRp:pDepartment") == true) {
			...
			if (parentElement.getQName().equals("mmlRp:perform")) {
				((mmlRpperform)builder.getParent()).setPDepartment((mmlRppDepartment)builder.getElement());
			}
