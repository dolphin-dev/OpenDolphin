 ...
 * @version
 */
public class xhtmlu extends MMLObject {
	...
	public boolean buildStart(String namespaceURI, String localName, String qName, Attributes atts, MMLBuilder builder) {
		if (qName.equals("xhtml:u") == true) {
			super.buildStart(namespaceURI,localName,qName,atts,builder);
			printlnStatus(parentElement.getQName() + " " + qName);
			
			/* create tree node */
			xhtmlu obj = new xhtmlu();
			builder.getMmlTree().addElement( obj );
			obj.setParentIndex( builder.mmlTreeIndex );
			builder.adjustIndex();
			((xhtmlu)builder.getElement()).setNamespace( getNamespace() );
			((xhtmlu)builder.getElement()).setLocalName( getLocalName() );
			((xhtmlu)builder.getElement()).setQName( getQName() );
			((xhtmlu)builder.getElement()).setAtts( getAtts() );/* :-) */
			/* atts */
			if (atts != null) {
				setXhtmlid( atts.getValue(namespaceURI, "id") );
				((xhtmlu)builder.getElement()).setXhtmlid( atts.getValue(namespaceURI, "id") );
				setXhtmlclass( atts.getValue(namespaceURI, "class") );
				((xhtmlu)builder.getElement()).setXhtmlclass( atts.getValue(namespaceURI, "class") );
				setXhtmlstyle( atts.getValue(namespaceURI, "style") );
				((xhtmlu)builder.getElement()).setXhtmlstyle( atts.getValue(namespaceURI, "style") );
				setXhtmltitle( atts.getValue(namespaceURI, "title") );
				((xhtmlu)builder.getElement()).setXhtmltitle( atts.getValue(namespaceURI, "title") );
				setXhtmllang( atts.getValue(namespaceURI, "lang") );
				((xhtmlu)builder.getElement()).setXhtmllang( atts.getValue(namespaceURI, "lang") );
				setXmllang( atts.getValue(namespaceURI, "lang") );
				((xhtmlu)builder.getElement()).setXmllang( atts.getValue(namespaceURI, "lang") );
				setXhtmldir( atts.getValue(namespaceURI, "dir") );
				((xhtmlu)builder.getElement()).setXhtmldir( atts.getValue(namespaceURI, "dir") );
				setXhtmlonclick( atts.getValue(namespaceURI, "onclick") );
				((xhtmlu)builder.getElement()).setXhtmlonclick( atts.getValue(namespaceURI, "onclick") );
				setXhtmlondblclick( atts.getValue(namespaceURI, "ondblclick") );
				((xhtmlu)builder.getElement()).setXhtmlondblclick( atts.getValue(namespaceURI, "ondblclick") );
				setXhtmlonmousedown( atts.getValue(namespaceURI, "onmousedown") );
				((xhtmlu)builder.getElement()).setXhtmlonmousedown( atts.getValue(namespaceURI, "onmousedown") );
				setXhtmlonmouseup( atts.getValue(namespaceURI, "onmouseup") );
				((xhtmlu)builder.getElement()).setXhtmlonmouseup( atts.getValue(namespaceURI, "onmouseup") );
				setXhtmlonmouseover( atts.getValue(namespaceURI, "onmouseover") );
				((xhtmlu)builder.getElement()).setXhtmlonmouseover( atts.getValue(namespaceURI, "onmouseover") );
				setXhtmlonmousemove( atts.getValue(namespaceURI, "onmousemove") );
				((xhtmlu)builder.getElement()).setXhtmlonmousemove( atts.getValue(namespaceURI, "onmousemove") );
				setXhtmlonmouseout( atts.getValue(namespaceURI, "onmouseout") );
				((xhtmlu)builder.getElement()).setXhtmlonmouseout( atts.getValue(namespaceURI, "onmouseout") );
				setXhtmlonkeypress( atts.getValue(namespaceURI, "onkeypress") );
				((xhtmlu)builder.getElement()).setXhtmlonkeypress( atts.getValue(namespaceURI, "onkeypress") );
				setXhtmlonkeydown( atts.getValue(namespaceURI, "onkeydown") );
				((xhtmlu)builder.getElement()).setXhtmlonkeydown( atts.getValue(namespaceURI, "onkeydown") );
				setXhtmlonkeyup( atts.getValue(namespaceURI, "onkeyup") );
				((xhtmlu)builder.getElement()).setXhtmlonkeyup( atts.getValue(namespaceURI, "onkeyup") );
			}
	...
	public boolean buildEnd(String namespaceURI, String localName, String qName, MMLBuilder builder) {
		if (qName.equals("xhtml:u") == true) {
			...
			if (parentElement.getQName().equals("xhtml:u")) {
				...
				v.addElement( (xhtmlu)builder.getElement() );
			}
	...
	public boolean characters(char[] ch, int start, int length, MMLBuilder builder) {
		if (builder.getCurrentElement().getQName().equals("xhtml:u")) {
			StringBuffer buffer = new StringBuffer(length);
			buffer.append(ch, start, length);
			vt.addElement(buffer.toString());
			((xhtmlu)builder.getElement()).getVt().addElement(buffer.toString());
