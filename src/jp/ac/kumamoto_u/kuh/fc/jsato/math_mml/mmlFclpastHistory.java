...
public class mmlFclpastHistory extends MMLObject {
	...
	public boolean buildEnd(String namespaceURI, String localName, String qName, MMLBuilder builder) {
		if (qName.equals("mmlFcl:pastHistory") == true) {
			...
			if (parentElement.getQName().equals("mmlFcl:FirstClinicModule")) {
				((mmlFclFirstClinicModule)builder.getParent()).setPastHistory((mmlFclpastHistory)builder.getElement());
			}
	...
	/* setters and getters */
	public void setFreeNotes(mmlFclfreeNotes _freeNotes) {
		this._freeNotes = _freeNotes;
	}
	public mmlFclfreeNotes getFreeNotes() {
		return _freeNotes;
	}
	public void setPastHistoryItem(Vector _pastHistoryItem) {
	...
	public Vector getPastHistoryItem() {
