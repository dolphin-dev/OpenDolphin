...
public class mmlSmstaffs extends MMLObject {
	...
	public boolean buildEnd(String namespaceURI, String localName, String qName, MMLBuilder builder) {
		if (qName.equals("mmlSm:staffs") == true) {
			...
			if (parentElement.getQName().equals("mmlSm:outPatientItem")) {
				((mmlSmoutPatientItem)builder.getParent()).setStaffs((mmlSmstaffs)builder.getElement());
			}

			if (parentElement.getQName().equals("mmlSm:inPatientItem")) {
				((mmlSminPatientItem)builder.getParent()).setStaffs((mmlSmstaffs)builder.getElement());
			}
	...
	/* setters and getters */
	public void setStaffInfo(Vector _staffInfo) {
