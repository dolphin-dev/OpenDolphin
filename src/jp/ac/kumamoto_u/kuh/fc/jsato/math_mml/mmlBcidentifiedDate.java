	...
	public boolean buildEnd(String namespaceURI, String localName, String qName, MMLBuilder builder) {
		if (qName.equals("mmlBc:identifiedDate") == true) {
			...
			if (parentElement.getQName().equals("mmlBc:infectionItem")) {
				((mmlBcinfectionItem)builder.getParent()).setIdentifiedDate((mmlBcidentifiedDate)builder.getElement());
			}

			if (parentElement.getQName().equals("mmlBc:allergyItem")) {
				((mmlBcallergyItem)builder.getParent()).setIdentifiedDate((mmlBcidentifiedDate)builder.getElement());
			}
