...
public class mmlSgstaffInfo extends MMLObject {
	...
	public boolean buildEnd(String namespaceURI, String localName, String qName, MMLBuilder builder) {
		if (qName.equals("mmlSg:staffInfo") == true) {
			...
			if (parentElement.getQName().equals("mmlSg:staff")) {
				((mmlSgstaff)builder.getParent()).setStaffInfo((mmlSgstaffInfo)builder.getElement());
			}
	...
	/* setters and getters */
	public void setPersonalizedInfo(Vector _PersonalizedInfo) {
	...
	public Vector getPersonalizedInfo() {
