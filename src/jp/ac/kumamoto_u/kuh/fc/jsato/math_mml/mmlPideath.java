...
public class mmlPideath extends MMLObject {
	...
	public boolean buildStart(String namespaceURI, String localName, String qName, Attributes atts, MMLBuilder builder) {
		if (qName.equals("mmlPi:death") == true) {
			...
			/* atts */
			if (atts != null) {
				setMmlPidate( atts.getValue(namespaceURI, "date") );
				((mmlPideath)builder.getElement()).setMmlPidate( atts.getValue(namespaceURI, "date") );
			}
	...
	public boolean buildEnd(String namespaceURI, String localName, String qName, MMLBuilder builder) {
		if (qName.equals("mmlPi:death") == true) {
			...
			if (parentElement.getQName().equals("mmlPi:PatientModule")) {
				((mmlPiPatientModule)builder.getParent()).setDeath((mmlPideath)builder.getElement());
			}
	...
	/* setters and getters */
	public void setMmlPidate(String __mmlPidate) {
		this.__mmlPidate = __mmlPidate;
	}
	public String getMmlPidate() {
		return __mmlPidate;
	}
