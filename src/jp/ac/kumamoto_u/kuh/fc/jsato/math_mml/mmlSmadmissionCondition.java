	...
	public boolean buildStart(String namespaceURI, String localName, String qName, Attributes atts, MMLBuilder builder) {
		if (qName.equals("mmlSm:admissionCondition") == true) {
			...
			if (atts != null) {
				...
				((mmlSmadmissionCondition)builder.getElement()).setMmlSmemergency( atts.getValue(namespaceURI, "emergency") );
			}
	...
	public boolean buildEnd(String namespaceURI, String localName, String qName, MMLBuilder builder) {
		if (qName.equals("mmlSm:admissionCondition") == true) {
			...
			if (parentElement.getQName().equals("mmlSm:admission")) {
				((mmlSmadmission)builder.getParent()).setAdmissionCondition((mmlSmadmissionCondition)builder.getElement());
			}
