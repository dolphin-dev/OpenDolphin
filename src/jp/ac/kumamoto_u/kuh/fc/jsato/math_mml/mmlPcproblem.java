...
public class mmlPcproblem extends MMLObject {
	...
	public boolean buildStart(String namespaceURI, String localName, String qName, Attributes atts, MMLBuilder builder) {
		if (qName.equals("mmlPc:problem") == true) {
			...
			/* atts */
			if (atts != null) {
				setMmlPcdxUid( atts.getValue(namespaceURI, "dxUid") );
				((mmlPcproblem)builder.getElement()).setMmlPcdxUid( atts.getValue(namespaceURI, "dxUid") );
			}
	...
	public boolean buildEnd(String namespaceURI, String localName, String qName, MMLBuilder builder) {
		if (qName.equals("mmlPc:problem") == true) {
			...
			if (parentElement.getQName().equals("mmlPc:problemItem")) {
				((mmlPcproblemItem)builder.getParent()).setProblem((mmlPcproblem)builder.getElement());
			}
	...
	/* setters and getters */
	public void setMmlPcdxUid(String __mmlPcdxUid) {
		this.__mmlPcdxUid = __mmlPcdxUid;
	}
	public String getMmlPcdxUid() {
		return __mmlPcdxUid;
	}
