...
public class mmlPinationality extends MMLObject {
	...
	public boolean buildStart(String namespaceURI, String localName, String qName, Attributes atts, MMLBuilder builder) {
		if (qName.equals("mmlPi:nationality") == true) {
			...
			/* atts */
			if (atts != null) {
				setMmlPisubtype( atts.getValue(namespaceURI, "subtype") );
				((mmlPinationality)builder.getElement()).setMmlPisubtype( atts.getValue(namespaceURI, "subtype") );
			}
	...
	public boolean buildEnd(String namespaceURI, String localName, String qName, MMLBuilder builder) {
		if (qName.equals("mmlPi:nationality") == true) {
			...
			if (parentElement.getQName().equals("mmlPi:PatientModule")) {
				((mmlPiPatientModule)builder.getParent()).setNationality((mmlPinationality)builder.getElement());
			}
	...
	/* setters and getters */
	public void setMmlPisubtype(String __mmlPisubtype) {
		this.__mmlPisubtype = __mmlPisubtype;
	}
	public String getMmlPisubtype() {
