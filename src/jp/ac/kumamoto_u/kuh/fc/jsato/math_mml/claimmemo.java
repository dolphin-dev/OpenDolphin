	...
	public boolean buildEnd(String namespaceURI, String localName, String qName, MMLBuilder builder) {
		if (qName.equals("claim:memo") == true) {
			...
			if (parentElement.getQName().equals("claim:item")) {
				((claimitem)builder.getParent()).setMemo((claimmemo)builder.getElement());
			}

			if (parentElement.getQName().equals("claim:bundle")) {
				((claimbundle)builder.getParent()).setMemo((claimmemo)builder.getElement());
			}

			if (parentElement.getQName().equals("claim:appoint")) {
				((claimappoint)builder.getParent()).setMemo((claimmemo)builder.getElement());
			}
