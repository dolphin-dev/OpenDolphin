...
public class mmlRddiagnosisContents extends MMLObject {
	...
	public boolean buildEnd(String namespaceURI, String localName, String qName, MMLBuilder builder) {
		if (qName.equals("mmlRd:diagnosisContents") == true) {
			...
			if (parentElement.getQName().equals("mmlRd:RegisteredDiagnosisModule")) {
				((mmlRdRegisteredDiagnosisModule)builder.getParent()).setDiagnosisContents((mmlRddiagnosisContents)builder.getElement());
			}
	...
	/* setters and getters */
	public void setDxItem(Vector _dxItem) {
