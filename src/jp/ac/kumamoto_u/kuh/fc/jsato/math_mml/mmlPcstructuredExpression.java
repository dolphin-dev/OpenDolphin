...
public class mmlPcstructuredExpression extends MMLObject {
	...
	public boolean buildEnd(String namespaceURI, String localName, String qName, MMLBuilder builder) {
		if (qName.equals("mmlPc:structuredExpression") == true) {
			...
			if (parentElement.getQName().equals("mmlPc:ProgressCourseModule")) {
				((mmlPcProgressCourseModule)builder.getParent()).setStructuredExpression((mmlPcstructuredExpression)builder.getElement());
			}
	...
	/* setters and getters */
	public void setProblemItem(Vector _problemItem) {
