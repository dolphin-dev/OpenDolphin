	...
	public boolean buildStart(String namespaceURI, String localName, String qName, Attributes atts, MMLBuilder builder) {
		if (qName.equals("xhtml:i") == true) {
			...
			if (atts != null) {
				...
				((xhtmli)builder.getElement()).setXhtmlid( atts.getValue(namespaceURI, "id") );
				setXhtmlclass( atts.getValue(namespaceURI, "class") );
				((xhtmli)builder.getElement()).setXhtmlclass( atts.getValue(namespaceURI, "class") );
				setXhtmlstyle( atts.getValue(namespaceURI, "style") );
				((xhtmli)builder.getElement()).setXhtmlstyle( atts.getValue(namespaceURI, "style") );
				setXhtmltitle( atts.getValue(namespaceURI, "title") );
				((xhtmli)builder.getElement()).setXhtmltitle( atts.getValue(namespaceURI, "title") );
				setXhtmllang( atts.getValue(namespaceURI, "lang") );
				((xhtmli)builder.getElement()).setXhtmllang( atts.getValue(namespaceURI, "lang") );
				setXmllang( atts.getValue(namespaceURI, "lang") );
				((xhtmli)builder.getElement()).setXmllang( atts.getValue(namespaceURI, "lang") );
				setXhtmldir( atts.getValue(namespaceURI, "dir") );
				((xhtmli)builder.getElement()).setXhtmldir( atts.getValue(namespaceURI, "dir") );
				setXhtmlonclick( atts.getValue(namespaceURI, "onclick") );
				((xhtmli)builder.getElement()).setXhtmlonclick( atts.getValue(namespaceURI, "onclick") );
				setXhtmlondblclick( atts.getValue(namespaceURI, "ondblclick") );
				((xhtmli)builder.getElement()).setXhtmlondblclick( atts.getValue(namespaceURI, "ondblclick") );
				setXhtmlonmousedown( atts.getValue(namespaceURI, "onmousedown") );
				((xhtmli)builder.getElement()).setXhtmlonmousedown( atts.getValue(namespaceURI, "onmousedown") );
				setXhtmlonmouseup( atts.getValue(namespaceURI, "onmouseup") );
				((xhtmli)builder.getElement()).setXhtmlonmouseup( atts.getValue(namespaceURI, "onmouseup") );
				setXhtmlonmouseover( atts.getValue(namespaceURI, "onmouseover") );
				((xhtmli)builder.getElement()).setXhtmlonmouseover( atts.getValue(namespaceURI, "onmouseover") );
				setXhtmlonmousemove( atts.getValue(namespaceURI, "onmousemove") );
				((xhtmli)builder.getElement()).setXhtmlonmousemove( atts.getValue(namespaceURI, "onmousemove") );
				setXhtmlonmouseout( atts.getValue(namespaceURI, "onmouseout") );
				((xhtmli)builder.getElement()).setXhtmlonmouseout( atts.getValue(namespaceURI, "onmouseout") );
				setXhtmlonkeypress( atts.getValue(namespaceURI, "onkeypress") );
				((xhtmli)builder.getElement()).setXhtmlonkeypress( atts.getValue(namespaceURI, "onkeypress") );
				setXhtmlonkeydown( atts.getValue(namespaceURI, "onkeydown") );
				((xhtmli)builder.getElement()).setXhtmlonkeydown( atts.getValue(namespaceURI, "onkeydown") );
				setXhtmlonkeyup( atts.getValue(namespaceURI, "onkeyup") );
				((xhtmli)builder.getElement()).setXhtmlonkeyup( atts.getValue(namespaceURI, "onkeyup") );
			}
