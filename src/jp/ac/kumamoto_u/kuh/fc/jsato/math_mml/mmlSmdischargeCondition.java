...
public class mmlSmdischargeCondition extends MMLObject {
	...
	public boolean buildStart(String namespaceURI, String localName, String qName, Attributes atts, MMLBuilder builder) {
		if (qName.equals("mmlSm:dischargeCondition") == true) {
			...
			/* atts */
			if (atts != null) {
				setMmlSmoutcome( atts.getValue(namespaceURI, "outcome") );
				((mmlSmdischargeCondition)builder.getElement()).setMmlSmoutcome( atts.getValue(namespaceURI, "outcome") );
			}
	...
	public boolean buildEnd(String namespaceURI, String localName, String qName, MMLBuilder builder) {
		if (qName.equals("mmlSm:dischargeCondition") == true) {
			...
			if (parentElement.getQName().equals("mmlSm:discharge")) {
				((mmlSmdischarge)builder.getParent()).setDischargeCondition((mmlSmdischargeCondition)builder.getElement());
			}
	...
	/* setters and getters */
	public void setMmlSmoutcome(String __mmlSmoutcome) {
		this.__mmlSmoutcome = __mmlSmoutcome;
	}
	public String getMmlSmoutcome() {
