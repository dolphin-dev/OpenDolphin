...
public class mmlHipublicInsurance extends MMLObject {
	...
	public boolean buildEnd(String namespaceURI, String localName, String qName, MMLBuilder builder) {
		if (qName.equals("mmlHi:publicInsurance") == true) {
			...
			if (parentElement.getQName().equals("mmlHi:HealthInsuranceModule")) {
				((mmlHiHealthInsuranceModule)builder.getParent()).setPublicInsurance((mmlHipublicInsurance)builder.getElement());
			}
	...
	/* setters and getters */
	public void setPublicInsuranceItem(Vector _publicInsuranceItem) {
	...
	public Vector getPublicInsuranceItem() {
