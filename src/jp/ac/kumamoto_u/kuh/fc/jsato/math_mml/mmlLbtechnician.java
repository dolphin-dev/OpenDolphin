...
public class mmlLbtechnician extends MMLObject {
	...
	public boolean buildStart(String namespaceURI, String localName, String qName, Attributes atts, MMLBuilder builder) {
		if (qName.equals("mmlLb:technician") == true) {
			...
			/* atts */
			if (atts != null) {
				setMmlLbtechCode( atts.getValue(namespaceURI, "techCode") );
				((mmlLbtechnician)builder.getElement()).setMmlLbtechCode( atts.getValue(namespaceURI, "techCode") );
				setMmlLbtechCodeId( atts.getValue(namespaceURI, "techCodeId") );
				((mmlLbtechnician)builder.getElement()).setMmlLbtechCodeId( atts.getValue(namespaceURI, "techCodeId") );
			}
	...
	public boolean buildEnd(String namespaceURI, String localName, String qName, MMLBuilder builder) {
		if (qName.equals("mmlLb:technician") == true) {
			...
			if (parentElement.getQName().equals("mmlLb:information")) {
				((mmlLbinformation)builder.getParent()).setTechnician((mmlLbtechnician)builder.getElement());
			}
	...
	/* setters and getters */
	public void setMmlLbtechCode(String __mmlLbtechCode) {
		this.__mmlLbtechCode = __mmlLbtechCode;
	}
	public String getMmlLbtechCode() {
		return __mmlLbtechCode;
	}
	public void setMmlLbtechCodeId(String __mmlLbtechCodeId) {
		this.__mmlLbtechCodeId = __mmlLbtechCodeId;
	}
	public String getMmlLbtechCodeId() {
