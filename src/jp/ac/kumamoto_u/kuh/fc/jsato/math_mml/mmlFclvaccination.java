...
public class mmlFclvaccination extends MMLObject {
	...
	public boolean buildEnd(String namespaceURI, String localName, String qName, MMLBuilder builder) {
		if (qName.equals("mmlFcl:vaccination") == true) {
			...
			if (parentElement.getQName().equals("mmlFcl:childhood")) {
				((mmlFclchildhood)builder.getParent()).setVaccination((mmlFclvaccination)builder.getElement());
			}
	...
	/* setters and getters */
	public void setVaccinationItem(Vector _vaccinationItem) {
	...
	public Vector getVaccinationItem() {
