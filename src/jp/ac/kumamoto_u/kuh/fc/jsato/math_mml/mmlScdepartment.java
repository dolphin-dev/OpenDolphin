...
public class mmlScdepartment extends MMLObject {
	...
	public boolean buildEnd(String namespaceURI, String localName, String qName, MMLBuilder builder) {
		if (qName.equals("mmlSc:department") == true) {
			...
			/* connection */
			if (parentElement.getQName().equals("accessRight")) {
				((accessRight)builder.getParent()).setDepartment((mmlScdepartment)builder.getElement());
			}
	...
	/* setters and getters */
	public void setDepartmentName(Vector _departmentName) {
	...
	public Vector getDepartmentName() {
