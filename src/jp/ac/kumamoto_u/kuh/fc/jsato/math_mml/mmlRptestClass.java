...
public class mmlRptestClass extends MMLObject {
	...
	public boolean buildStart(String namespaceURI, String localName, String qName, Attributes atts, MMLBuilder builder) {
		if (qName.equals("mmlRp:testClass") == true) {
			...
			/* atts */
			if (atts != null) {
				setMmlRptestClassCode( atts.getValue(namespaceURI, "testClassCode") );
				((mmlRptestClass)builder.getElement()).setMmlRptestClassCode( atts.getValue(namespaceURI, "testClassCode") );
				setMmlRptestClassCodeId( atts.getValue(namespaceURI, "testClassCodeId") );
				((mmlRptestClass)builder.getElement()).setMmlRptestClassCodeId( atts.getValue(namespaceURI, "testClassCodeId") );
			}
	...
	public boolean buildEnd(String namespaceURI, String localName, String qName, MMLBuilder builder) {
		if (qName.equals("mmlRp:testClass") == true) {
			...
			if (parentElement.getQName().equals("mmlRp:information")) {
				((mmlRpinformation)builder.getParent()).setTestClass((mmlRptestClass)builder.getElement());
			}
	...
	/* setters and getters */
	public void setMmlRptestClassCode(String __mmlRptestClassCode) {
		this.__mmlRptestClassCode = __mmlRptestClassCode;
	}
	public String getMmlRptestClassCode() {
		return __mmlRptestClassCode;
	}
	public void setMmlRptestClassCodeId(String __mmlRptestClassCodeId) {
		this.__mmlRptestClassCodeId = __mmlRptestClassCodeId;
	}
	public String getMmlRptestClassCodeId() {
