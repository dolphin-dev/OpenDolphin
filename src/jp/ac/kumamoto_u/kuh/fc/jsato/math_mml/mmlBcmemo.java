	...
	public boolean buildEnd(String namespaceURI, String localName, String qName, MMLBuilder builder) {
		if (qName.equals("mmlBc:memo") == true) {
			...
			if (parentElement.getQName().equals("mmlBc:infectionItem")) {
				((mmlBcinfectionItem)builder.getParent()).setMemo((mmlBcmemo)builder.getElement());
			}

			if (parentElement.getQName().equals("mmlBc:bloodtype")) {
				((mmlBcbloodtype)builder.getParent()).setMemo((mmlBcmemo)builder.getElement());
			}

			if (parentElement.getQName().equals("mmlBc:allergyItem")) {
				((mmlBcallergyItem)builder.getParent()).setMemo((mmlBcmemo)builder.getElement());
			}
