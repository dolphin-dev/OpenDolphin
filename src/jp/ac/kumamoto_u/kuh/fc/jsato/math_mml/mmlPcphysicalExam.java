...
public class mmlPcphysicalExam extends MMLObject {
	...
	public boolean buildEnd(String namespaceURI, String localName, String qName, MMLBuilder builder) {
		if (qName.equals("mmlPc:physicalExam") == true) {
			...
			if (parentElement.getQName().equals("mmlPc:objective")) {
				((mmlPcobjective)builder.getParent()).setPhysicalExam((mmlPcphysicalExam)builder.getElement());
			}
	...
	/* setters and getters */
	public void setPhysicalExamItem(Vector _physicalExamItem) {
	...
	public Vector getPhysicalExamItem() {
