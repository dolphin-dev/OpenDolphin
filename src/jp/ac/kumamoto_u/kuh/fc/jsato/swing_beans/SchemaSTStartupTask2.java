/*
 * SchemaSTStartupTask2.java
 *
 * Created on 2002/07/09, 14:41
 */
 ...
 * @version 
 */
public class SchemaSTStartupTask2 {
    ...
    /** Creates new SchemaSTStartupTask2 */
    public SchemaSTStartupTask2(SchemaStockTable panel, String schemaFolder) {
    ...
    class ActualTask {
        public ActualTask() {          
            ...
            System.out.println("StartupTask2: " + schemaFolder);
            ...
            panel.maintenanceButton(schemaFolder);
            panel.validate();
