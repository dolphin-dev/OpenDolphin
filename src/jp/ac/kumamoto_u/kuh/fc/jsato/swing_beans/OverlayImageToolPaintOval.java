/*
 * OverlayImageToolPaintOval.java
 *
 * Created on 2001/09/04, 10:10
 */
...
public class OverlayImageToolPaintOval extends OverlayImageTool {

    /** Creates new OverlayImageToolPaintOval */
    public OverlayImageToolPaintOval(OverlayImagePanelBean pnl) {
        super(pnl);
    }
    ...
    public void drawShape(Graphics g, Point p1, Point p2) {
        ...
        g.drawOval(lt.x, lt.y, rb.x - lt.x, rb.y - lt.y);
    }
    ...
    public void drawShape2(Graphics g, Point p1, Point p2) {
        ...
        //g.fillOval(lt.x, lt.y, rb.x - lt.x, rb.y - lt.y);
        
        Graphics2D g2 = (Graphics2D)g;
        float alpha = 0.5f;
        AlphaComposite ac = AlphaComposite.getInstance(AlphaComposite.SRC_OVER, alpha);  
        g2.setComposite(ac);
        g2.fill(new Ellipse2D.Double(lt.x, lt.y, rb.x - lt.x, rb.y - lt.y));
    }
