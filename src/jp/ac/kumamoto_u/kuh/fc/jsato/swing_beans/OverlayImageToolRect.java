/*
 * OverlayImageToolRect.java
 *
 * Created on 2001/09/04, 3:13
 */
...
public class OverlayImageToolRect extends OverlayImageTool {

    /** Creates new OverlayImageToolRect */
    public OverlayImageToolRect(OverlayImagePanelBean pnl) {
        super(pnl);
    }
    ...
    public void drawShape(Graphics g, Point p1, Point p2) {
        ...
        Stroke saved = g2.getStroke();
            ...
            g2.setStroke(stroke);
            g2.draw(new Rectangle2D.Double(lt.x, lt.y, rb.x - lt.x, rb.y - lt.y));
        g2.setStroke(saved);
    }
