...
public final class StringTool {
    ...
    private static final char[] komoji = { 'Çü', 'Ç°', 'Ç£', 'Ç•', 'Çß', 'Ç¡', 'Ç·',
    'Ç„', 'ÇÂ', 'ÇÏ', 'É@', 'ÉB', 'ÉD', 'ÉF', 'ÉH', 'Éb', 'ÉÉ', 'ÉÖ', 'Éá', 'Éé' };
    
    private static final Character[] HIRAGANA = { new Character('Ç†'), new Character('ÇÒ') };
    
    private static final Character[] KATAKANA = { new Character('ÉA'), new Character('Éì') };
    
    private static final Character[] ZENKAKU_UPPER = {new Character('Ç`'), new Character('Çy')};
    
    private static final Character[] ZENKAKU_LOWER = {new Character('ÇÅ'), new Character('Çö')};
