...
public class DocumentHistoryView extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        docTypeCombo.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "カルテ", "紹介状" }));
        docTypeCombo.setToolTipText(resourceMap.getString("docTypeCombo.toolTipText")); // NOI18N
        docTypeCombo.setName("docTypeCombo"); // NOI18N

        periodCombo.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "1年", "1ヶ月", "3ヶ月", "半年", "1年", "2年", "3年", "全て" }));
        periodCombo.setToolTipText(resourceMap.getString("periodCombo.toolTipText")); // NOI18N
