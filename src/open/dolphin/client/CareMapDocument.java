...
public final class CareMapDocument extends DefaultChartDocument {
    ...
    private void getModuleList(final boolean appo) {
        ...
        final ModuleTask worker = new ModuleTask(spec, ddl, appo, taskLength);
        ...
        taskTimer = new javax.swing.Timer(delay, new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (worker.isDone()) {
                    ...
                    if (ddl.isNoError()) {
                        setAllModules(worker.getModuleList());
                        if (appo) {
                            setAllAppointments(worker.getAppointmentList());
                        }
                        
                    } else {
                        warning(ClientContext.getString("careMap.title"), ddl.getErrorMessage());
                    }
    ...
    private void getImageList() {
        ...
        int delay = ClientContext.getInt("task.default.delay");
        int taskLength = maxEstimation/delay;
        final ImageTask worker = new ImageTask(spec, ddl, taskLength);
        ...
        taskTimer = new javax.swing.Timer(delay, new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (worker.isDone()) {
                    ...
                    if (ddl.isNoError()) {
                        setAllImages(worker.getImageList());
                    } else {
                        warning(ClientContext.getString("careMap.title"), ddl.getErrorMessage());
                    }
...
//    }
    ...
    public void save() {
        ...
        int delay = ClientContext.getInt("task.default.delay");
        int taskLength = maxEstimation/delay;
        final AppointTask worker = new AppointTask(results, adl, taskLength);
        ...
        taskTimer = new javax.swing.Timer(delay, new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (worker.isDone()) {
                    statusPanel.stop(worker.getMessage());
                    taskTimer.stop();
                    
                    if (adl.isNoError()) {
                        setDirty(false);
                    } else {
                        warning(ClientContext.getString("careMap.title"),adl.getErrorMessage());
                    }
