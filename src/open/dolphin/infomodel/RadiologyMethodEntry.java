 ...
 *
 */
public class RadiologyMethodEntry extends MasterEntry {
	
	private String hierarchyCode1;
	private String hierarchyCode2;

	/** Creates a new instance of RadiologyMethodEntry */
	public RadiologyMethodEntry() {
	}
