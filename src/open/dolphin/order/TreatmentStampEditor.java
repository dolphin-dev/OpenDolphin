...
public final class TreatmentStampEditor extends StampModelEditor  {
    ...
    //private static final String orderClass          = "40";
    //private static final String orderName           = "èà íu";
    //private static final String classCode           = "400";
    ...
    public TreatmentStampEditor() {
        ...
        String[] spec = ClientContext.getStringArray("claim.order.treatment.spec");
