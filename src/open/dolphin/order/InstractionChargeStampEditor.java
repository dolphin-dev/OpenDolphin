...
public final class InstractionChargeStampEditor extends StampModelEditor  {
    ...
    //private static final String orderClass          = "130-140";
    //private static final String orderName           = "指導・在宅";
    ...
    public InstractionChargeStampEditor() {
        ...
        String[] spec = ClientContext.getStringArray("claim.order.instractionCharge.spec");
