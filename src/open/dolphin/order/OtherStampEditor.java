...
public final class OtherStampEditor extends StampModelEditor  {
    ...
    //private static final String orderClass          = "80";    
    //private static final String orderName           = "‚»‚Ì‘¼";
    //private static final String classCode           = "800";
    ...
    public OtherStampEditor() {
        ...
        String[] spec = ClientContext.getStringArray("claim.order.other.spec");
