...
public final class PhysiologyStampEditor extends StampModelEditor  {
    ...
    //private static final String orderClass          = "61";    
    //private static final String orderName           = "ê∂óùÅEì‡éããæåüç∏";
    ...
    public PhysiologyStampEditor() {
        ...
        String[] spec = ClientContext.getStringArray("claim.order.physiology.spec");
