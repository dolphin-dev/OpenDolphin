...
public class RadView extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(open.dolphin.client.Dolphin.class).getContext().getResourceMap(RadView.class);
        ...
        partCheck.setText(resourceMap.getString("partCheck.text")); // NOI18N
        partCheck.setToolTipText(resourceMap.getString("partCheck.toolTipText")); // NOI18N
        partCheck.setEnabled(false);
        partCheck.setName("partCheck"); // NOI18N

        techCheck.setText(resourceMap.getString("techCheck.text")); // NOI18N
        techCheck.setToolTipText(resourceMap.getString("techCheck.toolTipText")); // NOI18N
        techCheck.setEnabled(false);
        techCheck.setName("techCheck"); // NOI18N
        ...
        partBtn.setText(resourceMap.getString("partBtn.text")); // NOI18N
        partBtn.setToolTipText(resourceMap.getString("partBtn.toolTipText")); // NOI18N
        partBtn.setName("partBtn"); // NOI18N
