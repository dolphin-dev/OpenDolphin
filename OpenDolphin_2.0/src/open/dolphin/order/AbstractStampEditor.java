...
public abstract class AbstractStampEditor {
    ...
    // 編集可能コメント
    protected static final String EDITABLE_COMMENT_81 = "810000001";
    protected static final String EDITABLE_COMMENT_83 = "83";
    protected static final String EDITABLE_COMMENT_0084 = "0084";
    protected static final String EDITABLE_COMMENT_85 = "008500000";
    ...
    // 内容を編集できるコメントコード
    //---------------------------------------
    protected static boolean isEditableComment(String code) {
        
        boolean editable = (code!=null && (code.equals(EDITABLE_COMMENT_81) ||
                                           code.startsWith(EDITABLE_COMMENT_83) ||
                                           code.startsWith(EDITABLE_COMMENT_0084) ||
                                           code.equals(EDITABLE_COMMENT_85)))
                         ? true
                         : false;
        return editable;
    }
