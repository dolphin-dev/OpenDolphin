...
public class KarteSettingPanel extends AbstractSettingPanel {
    ...
    private boolean defaultColoring;
    ...
    private void bindViewToModel() {
        ...
        Project.setInt(Project.OFFSET_OUTCOME_DATE, Integer.parseInt(val));
    ...
    class KarteModel {
        ...
        public void populate(ProjectStub stub) {
            ...
            setMasterItemColoring(stub.getMasterItemColoring());
...
//            ClientContext.getBootLogger().debug("populate-保存時の確認ダイアログ表示:"+ isConfirmAtSave());
            ...
            // 自動クローズ
            setAutoCloseAtSave(stub.isAutoCloseAfterSaving());

            // 月齢表示年齢
            setAgeNeedMonth(stub.getAgeToNeedMonth());
        }
        ...
        public void restore(ProjectStub stub) {
            ...
            stub.setMasterItemColoring(isMasterItemColoring());
...
//            ClientContext.getBootLogger().debug("restore-保存時の確認ダイアログ表示:"+ isConfirmAtSave());
            ...
            // 自動クローズ
            stub.setAutoCloseAfterSaving(isAutoCloseAtSave());

            // 月齢表示年齢
            stub.setAgeToNeedMonth(getAgeNeedMonth());
        }
...
//        }
    ...
    public void restoreDefault() {
        ...
        masterItemColoring.setSelected(defaultColoring);
    }
