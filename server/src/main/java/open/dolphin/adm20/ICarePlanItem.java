...
public class ICarePlanItem {
    ...
    private ICarePlanModel carePlanMode;
    ...
    public void fromModel(CarePlanItem model) {
    ...
    public CarePlanItem toModel() {
        
        CarePlanItem ret = new CarePlanItem();
    ...
    public ICarePlanModel getCarePlanMode() {
        return carePlanMode;
    }

    public void setCarePlanMode(ICarePlanModel carePlanMode) {
        this.carePlanMode = carePlanMode;
    }
}
