...
//s.oh$
    ...
    private final void initComponents() {
        ...
        // Resource Injection
        java.util.ResourceBundle bundle = ClientContext.getMyBundle(InjectionEditor.class);
        ...
        // 手技料なし
        NO_CHARGE = bundle.getString("text.noProcedureCharge");
