...
public class SchemaEditorImpl implements SchemaEditor {
    ...
    private void initComponents() {
        ...
        try {
            Properties old = (Properties) ClientContext.getLocalStorage().load("schemaEditorProp.xml");

            if (old != null) {
                ClientContext.getLocalStorage().deleteFile("schemaEditorProp.xml");
                Project.setString("schemaEditor.lineWidth", old.getProperty("lineWidth"));
                Project.setString("schemaEditor.fillColor", old.getProperty("fillColor"));
                Project.setString("schemaEditor.alpha", old.getProperty("alpha"));
            }
